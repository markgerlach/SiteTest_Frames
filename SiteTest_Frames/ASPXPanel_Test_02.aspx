<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ASPXPanel_Test_02.aspx.cs" Inherits="SiteTest_Frames.ASPXPanel_Test_02" %>
							...
							<Groups>
								<dx:NavBarGroup Text="Function List" ItemBulletStyle="Circle">
									<Items>
										...
										<dx:NavBarItem Text="Contact Demographics"></dx:NavBarItem>
									</Items>
								</dx:NavBarGroup>
