...
namespace LEAD_Log
{
	...
	/// </summary>
	#region LogSystem Class
	[Serializable]
	public partial class LogSystem : LEAD_Log_BaseObject, 
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		private string _updatedByEmail = null;
		private DateTime _dtUpdated = DateTime.Now;
		private byte[] _rowversion = null;

		private LogSystem _originalValues = null;
		...
		/// <summary>
		/// Builds a LogSystembased on a certain record from the database.
		/// </summary>
		/// <param name="logID">A primary key used to select the record.</param>
		public LogSystem(long logID)
		{
			this.Get(logID);
		...
		/// <summary>
		/// Property generated from the iLogID field.
		/// </summary>
		public long LogID
		{
			get 
			...
			set 
			{
				if (_logID != value)
				{
					bool cancelled = NotifyPropertyChanging("LogID", _logID, value);
					if (!cancelled)
					{
						_logID = value;
						SetModifiedStatus("LogID");
						NotifyPropertyChanged("LogID", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sEventType field.
		/// </summary>
		public string EventType
		{
			...
			set 
			{
				if (_eventType != value)
				{
					bool cancelled = NotifyPropertyChanging("EventType", _eventType, value);
					if (!cancelled)
					{
						_eventType = value;
						SetModifiedStatus("EventType");
						NotifyPropertyChanged("EventType", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sMessage field.
		/// </summary>
		public string Message
		{
			...
			set 
			{
				if (_message != value)
				{
					bool cancelled = NotifyPropertyChanging("Message", _message, value);
					if (!cancelled)
					{
						_message = value;
						SetModifiedStatus("Message");
						NotifyPropertyChanged("Message", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sAddedByEmail field.
		/// </summary>
		public string AddedByEmail
		{
			...
			set 
			{
				...
				{
					bool cancelled = NotifyPropertyChanging("AddedByEmail", _addedByEmail, value);
					if (!cancelled)
					{
						_addedByEmail = value;
						SetModifiedStatus("AddedByEmail");
						NotifyPropertyChanged("AddedByEmail", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sUpdatedByEmail field.
		/// </summary>
		public string UpdatedByEmail
		{
			...
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
				return _updatedByEmail;
			}
			set 
			{
				if (_updatedByEmail != value)
				{
					bool cancelled = NotifyPropertyChanging("UpdatedByEmail", _updatedByEmail, value);
					if (!cancelled)
					{
						_updatedByEmail = value;
						SetModifiedStatus("UpdatedByEmail");
						NotifyPropertyChanged("UpdatedByEmail", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// A LogSystem with all of this object's original values.
		/// </summary>
		[Newtonsoft.Json.JsonIgnore]
		public LogSystem OriginalValues
		{
		...
		public void SetBaseRules()
		{
			...
			this.Rules.Add(new PropertyRequiredCustomRule("LogID", "The \"Log ID\" field is required in the LogSystem record.", RecordStatus.Modified));
			this.Rules.Add(new PropertyRequiredCustomRule("DateLogged", "The \"Date Logged\" field is required in the LogSystem record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Inactive", "The \"Inactive\" field is required in the LogSystem record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateAdded", "The \"Date Added\" field is required in the LogSystem record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateUpdated", "The \"Date Updated\" field is required in the LogSystem record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Rowversion", "The \"Rowversion\" field is required in the LogSystem record.", RecordStatus.Modified));

			// Max Length Rules
			this.Rules.Add(new MaxLengthCustomRule("EventType", 200, "The maximum length for the \"EventType\" field is 200 characters."));
			this.Rules.Add(new MaxLengthCustomRule("Message", 5000, "The maximum length for the \"Message\" field is 5000 characters."));
			this.Rules.Add(new MaxLengthCustomRule("AddedByEmail", 200, "The maximum length for the \"AddedByEmail\" field is 200 characters."));
			this.Rules.Add(new MaxLengthCustomRule("UpdatedByEmail", 200, "The maximum length for the \"UpdatedByEmail\" field is 200 characters."));
		...
		public LogSystem Clone()
		{
			LogSystem item = base.CloneObjectWithIL<LogSystem>(this);
		...
		public ClassGenExceptionCollection RefreshObject(int threshHoldInMinutes)
		{
			...
			if (((TimeSpan)currentTime.Subtract(_dateTimeObjectPopulated.Value)).TotalMinutes > threshHoldInMinutes)
			{
				...
				errors.AddRange(this.Get(_logID));
			}
		...
		public ClassGenExceptionCollection RefreshForce()
		{
			...
			if (!String.IsNullOrEmpty(this._logID.ToString()))
			{
				errors.AddRange(this.Get(_logID));	// Just do a get on the object
			}
			else
			{
		...
		public override void UndoChanges()
		{
			...
			_logID = _originalValues.LogID;
			_dtLogged = _originalValues.DateLogged;
			_eventType = _originalValues.EventType;
			_message = _originalValues.Message;
			_inactive = _originalValues.Inactive;
			_addedByEmail = _originalValues.AddedByEmail;
			_dtAdded = _originalValues.DateAdded;
			_updatedByEmail = _originalValues.UpdatedByEmail;
		...
		public ClassGenExceptionCollection AddUpdate(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			if (_recordStatus == RecordStatus.Deleted)
			{
				try
				{
					...
					errors.AddRange(LEAD_Log_BaseObject.DeleteImmediate("tLogSystem", "iLogID", _logID.ToString(), true));
				}
				catch (SqlException sqle) { errors.Add(new ClassGenException(sqle)); }
				catch (Exception ex) { errors.Add(new ClassGenException(ex)); }
			...
			if (_recordStatus == RecordStatus.New || _recordStatus == RecordStatus.Modified)
			{
				...
				{
					byte[] timeStampFromTable = DAL.GetTimeStampFromTable("tLogSystem", "bRowversion",
						"iLogID = " + this.LogID + "");
				...
				try
				{
					...
					sql = "DECLARE @return_val BIGINT " + 
						"IF NOT EXISTS (SELECT iLogID FROM tLogSystem WHERE iLogID = @piLogID) " + 
						"BEGIN" + 
						"    INSERT INTO tLogSystem (dtLogged, sEventType, sMessage, bInactive, sAddedByEmail, sUpdatedByEmail, dtUpdated) " + 
						"    SELECT @pdtLogged, @psEventType, @psMessage, @pbInactive, @psAddedByEmail, @psUpdatedByEmail, @pdtUpdated " + 
						"    SELECT @return_val = SCOPE_IDENTITY() " + 
						"END " + 
						"ELSE " + 
						"BEGIN " + 
						"    UPDATE tLogSystem SET " + 
						"        dtLogged = @pdtLogged" + 
						"        ,bInactive = @pbInactive" + 
						"        ,dtUpdated = @pdtUpdated" + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("EventType")) ? "        ,sEventType = @psEventType" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("Message")) ? "        ,sMessage = @psMessage" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("AddedByEmail")) ? "        ,sAddedByEmail = @psAddedByEmail" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("UpdatedByEmail")) ? "        ,sUpdatedByEmail = @psUpdatedByEmail" : "") + 
						"     WHERE iLogID = @piLogID " + 
						"     SELECT @return_val = @piLogID " + 
						"END; SELECT @return_val AS ret_val, bRowversion FROM tLogSystem WHERE iLogID = @return_val";
					cmd = new SqlCommand(sql);

					cmd.Parameters.Add("@piLogID", SqlDbType.BigInt).Value = _logID;
					cmd.Parameters.Add("@pdtLogged", SqlDbType.DateTime).Value = _dtLogged;
					cmd.Parameters.Add("@psEventType", SqlDbType.VarChar, 200).Value = (_eventType == null ? (object)DBNull.Value : (object)_eventType);
					cmd.Parameters.Add("@psMessage", SqlDbType.VarChar, 5000).Value = (_message == null ? (object)DBNull.Value : (object)_message);
					cmd.Parameters.Add("@pbInactive", SqlDbType.Bit).Value = _inactive;
					cmd.Parameters.Add("@psAddedByEmail", SqlDbType.VarChar, 200).Value = (_addedByEmail == null ? (object)DBNull.Value : (object)_addedByEmail);
					cmd.Parameters.Add("@psUpdatedByEmail", SqlDbType.VarChar, 200).Value = (_updatedByEmail == null ? (object)DBNull.Value : (object)_updatedByEmail);
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						long oldRecID = _logID;

						_logID = (long)row["ret_val"];
		...
		/// </summary>
		/// <param name="logID">A key field used to find the correct record.</param>
		/// <param name="includeParentPopulation">Whether or not to include values derived from a parent table.</param>
		public ClassGenExceptionCollection Get(long logID, bool includeParentPopulation)
		{
			ClassGenExceptionCollection errors = new ClassGenExceptionCollection();
			SqlCommand cmd = null;
			string sql = string.Empty;
			...
			try
			{
				sql = "SELECT [LS].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tLogSystem [LS] " + 
					"WHERE [LS].[iLogID] = @piLogID " + 
					"";
				cmd = new SqlCommand(sql);
				cmd.Parameters.Add("@piLogID", SqlDbType.BigInt).Value = logID;
		...
		public ClassGenExceptionCollection Get(long logID)
		{
			return Get(logID, false);		// Get the item
		}
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_logID = long.Parse(row["iLogID"] != DBNull.Value ? row["iLogID"].ToString() : "0");
				_dtLogged = (row["dtLogged"] != DBNull.Value ? (DateTime)row["dtLogged"] : new DateTime(1900, 1, 1));
				_eventType = (row["sEventType"] != DBNull.Value ? _eventType = row["sEventType"].ToString() : null);
				_message = (row["sMessage"] != DBNull.Value ? _message = row["sMessage"].ToString() : null);
				_inactive = bool.Parse(row["bInactive"] != DBNull.Value ? row["bInactive"].ToString() : "false");
				
				_addedByEmail = (row["sAddedByEmail"] != DBNull.Value ? _addedByEmail = row["sAddedByEmail"].ToString() : null);
				_dtAdded = (row["dtAdded"] != DBNull.Value ? (DateTime)row["dtAdded"] : new DateTime(1900, 1, 1));
				_updatedByEmail = (row["sUpdatedByEmail"] != DBNull.Value ? _updatedByEmail = row["sUpdatedByEmail"].ToString() : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<LogSystem>(this, dt);
		}
		...
		/// </summary>
		public static readonly string FN_LogID = "LogID";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_EventType = "EventType";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_Message = "Message";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_AddedByEmail = "AddedByEmail";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_UpdatedByEmail = "UpdatedByEmail";
		...
		public static string GetDBFieldName(LogSystemField field)
		{
			...
			switch (field)
			{
				case LogSystemField.LogID: fldName = "iLogID"; break;
				case LogSystemField.DateLogged: fldName = "dtLogged"; break;
				case LogSystemField.EventType: fldName = "sEventType"; break;
				case LogSystemField.Message: fldName = "sMessage"; break;
				case LogSystemField.Inactive: fldName = "bInactive"; break;
				case LogSystemField.AddedByEmail: fldName = "sAddedByEmail"; break;
				case LogSystemField.DateAdded: fldName = "dtAdded"; break;
				case LogSystemField.UpdatedByEmail: fldName = "sUpdatedByEmail"; break;
				case LogSystemField.DateUpdated: fldName = "dtUpdated"; break;
				case LogSystemField.Rowversion: fldName = "bRowversion"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "ilogid") { fldName = LogSystemField.LogID.ToString(); }
			else if (field.ToLower() == "dtlogged") { fldName = LogSystemField.DateLogged.ToString(); }
			else if (field.ToLower() == "seventtype") { fldName = LogSystemField.EventType.ToString(); }
			else if (field.ToLower() == "smessage") { fldName = LogSystemField.Message.ToString(); }
			else if (field.ToLower() == "binactive") { fldName = LogSystemField.Inactive.ToString(); }
			else if (field.ToLower() == "saddedbyemail") { fldName = LogSystemField.AddedByEmail.ToString(); }
			else if (field.ToLower() == "dtadded") { fldName = LogSystemField.DateAdded.ToString(); }
			else if (field.ToLower() == "supdatedbyemail") { fldName = LogSystemField.UpdatedByEmail.ToString(); }
			else if (field.ToLower() == "dtupdated") { fldName = LogSystemField.DateUpdated.ToString(); }
			else if (field.ToLower() == "browversion") { fldName = LogSystemField.Rowversion.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "tLogSystem"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(LogSystemField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(LogSystemField field, string whereClause)
		{
		...
		public static DataTable GetDistinctFromDBAsDataTable(LogSystemField[] fields, 
			string[] fieldAliases,
			LogSystemField[] sortedFields, 
			string whereClause)
		{
			Dictionary<LogSystemField, string> fieldNames = new Dictionary<LogSystemField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (LogSystemField fld in fields)
			{
			...
			Dictionary<LogSystemField, string> sortedFieldNames = new Dictionary<LogSystemField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (LogSystemField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(LogSystemMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(LogSystemMinMaxDateField field, string whereClause)
		{
			LogSystemField fld = (LogSystemField)Enum.Parse(typeof(LogSystemField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(LogSystemMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(LogSystemMinMaxDateField field, string whereClause)
		{
			LogSystemField fld = (LogSystemField)Enum.Parse(typeof(LogSystemField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(LogSystemMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(LogSystemMinMaxNumberField field, string whereClause)
		{
			LogSystemField fld = (LogSystemField)Enum.Parse(typeof(LogSystemField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(LogSystemMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(LogSystemMinMaxNumberField field, string whereClause)
		{
			LogSystemField fld = (LogSystemField)Enum.Parse(typeof(LogSystemField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static LogSystem CopyFrom(LogSystem source)
		{
			// Make the copy of the object
			LogSystem item = source.Clone();
		...
		public static string ToDBFriendly(string dbString)
		{
			...
			rtv = rtv.Replace("[LogID]", "[iLogID]");
			rtv = rtv.Replace("[DateLogged]", "[dtLogged]");
			rtv = rtv.Replace("[EventType]", "[sEventType]");
			rtv = rtv.Replace("[Message]", "[sMessage]");
			rtv = rtv.Replace("[Inactive]", "[bInactive]");
			rtv = rtv.Replace("[AddedByEmail]", "[sAddedByEmail]");
			rtv = rtv.Replace("[DateAdded]", "[dtAdded]");
			rtv = rtv.Replace("[UpdatedByEmail]", "[sUpdatedByEmail]");
		...
		/// <summary>
		/// Attempt to serialize the LogSystem object to the server
		/// </summary>
		/// <param name="obj">The LogSystem object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(LogSystem obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the LogSystem object from the server
		/// </summary>
		/// <param name="obj">The LogSystem object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A LogSystem object containing the return from the method</returns>
		public static LogSystem DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			LogSystem rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<LogSystem>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<LogID>" + System.Security.SecurityElement.Escape(LogID.ToString()) + "</LogID>" + Environment.NewLine);
			sb.Append("<DateLogged>" + DateLogged.ToString("MM/dd/yyyy hh:mm:ss.ffffff tt") + "</DateLogged>" + Environment.NewLine);
			sb.Append("<EventType>" + System.Security.SecurityElement.Escape(EventType) + "</EventType>" + Environment.NewLine);
			sb.Append("<Message>" + System.Security.SecurityElement.Escape(Message) + "</Message>" + Environment.NewLine);
			sb.Append("<Inactive>" + System.Security.SecurityElement.Escape(Inactive.ToString()) + "</Inactive>" + Environment.NewLine);
			sb.Append("<AddedByEmail>" + System.Security.SecurityElement.Escape(AddedByEmail) + "</AddedByEmail>" + Environment.NewLine);
			sb.Append("<DateAdded>" + DateAdded.ToString("MM/dd/yyyy hh:mm:ss.ffffff tt") + "</DateAdded>" + Environment.NewLine);
			sb.Append("<UpdatedByEmail>" + System.Security.SecurityElement.Escape(UpdatedByEmail) + "</UpdatedByEmail>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<LogSystem>" + Environment.NewLine);
				sb.Append("</LogSystem>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			if (_originalValues.LogID != LogID)
			{
				sb.Append("\t<LogID>");
				sb.Append("<OldValue>" + _originalValues.LogID.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + LogID.ToString() + "</NewValue>");
				sb.Append("</LogID>" + Environment.NewLine);
			}
			...
			if (_originalValues.EventType != EventType)
			{
				sb.Append("\t<EventType>");
				sb.Append("<OldValue>" + _originalValues.EventType + "</OldValue>");
				sb.Append("<NewValue>" + EventType + "</NewValue>");
				sb.Append("</EventType>" + Environment.NewLine);
			}
			if (_originalValues.Message != Message)
			{
				sb.Append("\t<Message>");
				sb.Append("<OldValue>" + _originalValues.Message + "</OldValue>");
				sb.Append("<NewValue>" + Message + "</NewValue>");
			...
			if (_originalValues.AddedByEmail != AddedByEmail)
			{
				sb.Append("\t<AddedByEmail>");
				sb.Append("<OldValue>" + _originalValues.AddedByEmail + "</OldValue>");
				sb.Append("<NewValue>" + AddedByEmail + "</NewValue>");
				sb.Append("</AddedByEmail>" + Environment.NewLine);
			}
			...
			if (_originalValues.UpdatedByEmail != UpdatedByEmail)
			{
				sb.Append("\t<UpdatedByEmail>");
				sb.Append("<OldValue>" + _originalValues.UpdatedByEmail + "</OldValue>");
				sb.Append("<NewValue>" + UpdatedByEmail + "</NewValue>");
				sb.Append("</UpdatedByEmail>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new LogSystem object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new LogSystem object.</returns>
		public static LogSystem LoadFromXML(string xml)
		{
			...
			foreach (System.Xml.XmlNode child in doc.ChildNodes[0].ChildNodes)
			{
				...
				switch (child.Name)
				{
					case "LogID": item.LogID = long.Parse(child.InnerText); break;
					case "DateLogged": item.DateLogged = DateTime.Parse(child.InnerText); break;
					case "EventType": item.EventType = child.InnerText; break;
					case "Message": item.Message = child.InnerText; break;
					case "Inactive": item.Inactive = bool.Parse(child.InnerText); break;

					case "AddedByEmail": item.AddedByEmail = child.InnerText; break;
					case "DateAdded": item.DateAdded = DateTime.Parse(child.InnerText); break;
					case "UpdatedByEmail": item.UpdatedByEmail = child.InnerText; break;
	...
	#endregion LogSystem Class

	#region LogSystemField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum LogSystemField
	{
		/// <summary>
		/// The LogID element.
		/// </summary>
	...
	#endregion LogSystemField Enum

	#region LogSystemMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum LogSystemMinMaxDateField
	{
		/// <summary>
		/// The DateLogged element.
		/// </summary>
	...
	#endregion LogSystemMinMaxDateField Enum

	#region LogSystemMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum LogSystemMinMaxNumberField
	{
		/// <summary>
		/// The LogID element.
		/// </summary>
	...
	#endregion LogSystemMinMaxNumberField Enum

	#region LogSystem Collection
	/// <summary>
	/// A collection for LogSystem objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with LogSystem objects.
	/// Most of the functionality is in this class, including the methods for creating LogSystem objects from a database.
	/// </remarks>
	[Serializable]
	public partial class LogSystemCollection : ClassGenBindingList<LogSystem, long>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated, IClassGenClassUpdatable
	{
		...
		/// </summary>
		public LogSystemCollection() 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LogID";
		...
		public LogSystemCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LogID";
		...
		public LogSystemCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LogID";
		...
		/// </summary>
		/// <param name="logID">A key field used to find the correct record.</param>
		/// <returns>The LogSystem object that matches the given value.</returns>
		public LogSystem Get(long logID)
		{
			LogSystem val = null;
			if (KeyedCollection.ContainsKey(logID)) { val = KeyedCollection[logID]; }
			return val;
		}
		...
		/// </summary>
		public new LogSystemCollection ActiveRecords
		{
			get
			{
				return (LogSystemCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public LogSystemCollection DeletedRecords
		{
			get
			{
				return (LogSystemCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public LogSystemCollection ModifiedRecords
		{
			get
			{
				return (LogSystemCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public LogSystemCollection NewRecords
		{
			get
			{
				return (LogSystemCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = LogSystemCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = LogSystemCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [LS].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tLogSystem [LS] " + 
				...
				this.OnMasterPopulate("LogSystem", "Retrieving Full List Of LogSystems", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("LogSystem", 
						"Populating LogSystem: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
					...
					if (this.Contains(item.LogID)) { this.Remove(item.LogID); }
		...
		public ClassGenExceptionCollection AddUpdateAll(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			try
			{
				...
				{
					this.OnDetailDelete("LogSystem",
						"Deleting LogSystem: " + (this.Count - i + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						this.Count - i + 1);
					LogSystem item = this[i];
					if (item.RecordStatus == RecordStatus.Deleted)
					{
						...
						else
						{
							...
							{
								err.RecordIndex = i + 1;
								err.RecordKey = item.LogID.ToString();
							}
				...
				// Update Method
				int count = 0;
				foreach (LogSystem item in this)
				{
					this.OnDetailUpdate("LogSystem",
						"Updating LogSystem: " + (count + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						count + 1);
		...
		public new LogSystemCollection Clone()
		{
			LogSystemCollection newColl = new LogSystemCollection();
		...
		/// </summary>
		/// <returns>A new LogSystemCollection.</returns>
		public new LogSystemCollection CopyWithNewIDs()
		{
			return (LogSystemCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD_Log.LogSystemField field)
		{
			...
			switch (field)
			{
				case LEAD_Log.LogSystemField.LogID:
					foreach (LogSystem item in this)
					{
						if (!String.IsNullOrEmpty(item.LogID.ToString()) && 
							!vals.ContainsKey(item.LogID.ToString().Trim())) { vals.Add(item.LogID.ToString().Trim(), item.LogID.ToString().Trim()); }
					}
					break;
				case LEAD_Log.LogSystemField.EventType:
					foreach (LogSystem item in this)
					{
						if (!String.IsNullOrEmpty(item.EventType) && 
							!vals.ContainsKey(item.EventType.Trim())) { vals.Add(item.EventType.Trim(), item.EventType.Trim()); }
					}
					break;
				case LEAD_Log.LogSystemField.Message:
					foreach (LogSystem item in this)
					{
						if (!String.IsNullOrEmpty(item.Message) && 
							!vals.ContainsKey(item.Message.Trim())) { vals.Add(item.Message.Trim(), item.Message.Trim()); }
					}
					break;
				case LEAD_Log.LogSystemField.AddedByEmail:
					foreach (LogSystem item in this)
					{
						if (!String.IsNullOrEmpty(item.AddedByEmail) && 
							!vals.ContainsKey(item.AddedByEmail.Trim())) { vals.Add(item.AddedByEmail.Trim(), item.AddedByEmail.Trim()); }
					}
					break;
				case LEAD_Log.LogSystemField.UpdatedByEmail:
					foreach (LogSystem item in this)
					{
						if (!String.IsNullOrEmpty(item.UpdatedByEmail) && 
							!vals.ContainsKey(item.UpdatedByEmail.Trim())) { vals.Add(item.UpdatedByEmail.Trim(), item.UpdatedByEmail.Trim()); }
					}
					break;
			}
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (LogSystem item in this.ActiveRecords)
				{
					...
					if (exCollection.Count > 0)
					{
						foreach (ClassGenException ex in exCollection)
						{
							...
							ex.RecordKey = item.LogID.ToString();
						}
		...
		/// </summary>
		/// <returns>A LogSystemCollection of current records.</returns>
		public LogSystemCollection GetCurrent()
		{
		...
		{
			return (this.Exists(new Predicate<LogSystem>(delegate (LogSystem obj) 
				{ return obj.LogID == logID; })));
		}
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<LogSystem>();
		}
		...
		/// <summary>
		/// Attempt to serialize the LogSystemCollection object to the server
		/// </summary>
		/// <param name="obj">The LogSystemCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(LogSystemCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the LogSystemCollection object from the server
		/// </summary>
		/// <param name="obj">The LogSystemCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A LogSystemCollection object containing the return from the method</returns>
		public static LogSystemCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			LogSystemCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<LogSystemCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#LogSystem') IS NOT NULL  DROP TABLE #LogSystem; " + 
					"CREATE TABLE #LogSystem (iLogID bigint, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #LogSystem (iLogID) SELECT iLogID FROM tLogSystem" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #LogSystem "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				LogSystemCollection_GetAsyncObject obj = (LogSystemCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.LogSystemCollection);
			}
		}
			...
			int pageSize)
		{
			...
			LogSystemCollection coll = new LogSystemCollection();
			LogSystem item = new LogSystem();
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [LS].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tLogSystem [LS] " + 
					"INNER JOIN #LogSystem TEMP ON [LS].[iLogID] = [TEMP].[iLogID] " +
				...
				// Populate the local LogSystem collection
				coll = new LogSystemCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new LogSystem();
					item.Get(row);
				...
				// Report the progress
				LogSystemCollection_GetAsyncObject obj = new LogSystemCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, LogSystem_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, LogSystemCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (LogSystem a in coll)
				{
					this.Add(a);		// Add the LogSystem
				}

				LogSystem_GetCollection_EventArgs e = new LogSystem_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<LogSystemCollection>" + Environment.NewLine);
			sb.Append("</LogSystemCollection>" + Environment.NewLine);
			...
			foreach (LogSystem item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<LogSystem>" + Environment.NewLine);
						sbRead.Append("\t<LogID>" + item.LogID.ToString() + "</LogID>" + Environment.NewLine);
						sbRead.Append("\t<DateLogged>" + item.DateLogged.ToString() + "</DateLogged>" + Environment.NewLine);
						sbRead.Append("\t<EventType>" + (item.EventType != null ? item.EventType : "NULL") + "</EventType>" + Environment.NewLine);
						sbRead.Append("\t<Message>" + (item.Message != null ? item.Message : "NULL") + "</Message>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<LogSystem>" + Environment.NewLine);
						sbDeleted.Append("\t<LogID>" + item.LogID.ToString() + "</LogID>" + Environment.NewLine);
						sbDeleted.Append("\t<DateLogged>" + item.DateLogged.ToString() + "</DateLogged>" + Environment.NewLine);
						sbDeleted.Append("\t<EventType>" + (item.EventType != null ? item.EventType : "NULL") + "</EventType>" + Environment.NewLine);
						sbDeleted.Append("\t<Message>" + (item.Message != null ? item.Message : "NULL") + "</Message>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<LogSystem>" + Environment.NewLine);
						sbNew.Append("\t<LogID>" + item.LogID.ToString() + "</LogID>" + Environment.NewLine);
						sbNew.Append("\t<DateLogged>" + item.DateLogged.ToString() + "</DateLogged>" + Environment.NewLine);
						sbNew.Append("\t<EventType>" + (item.EventType != null ? item.EventType : "NULL") + "</EventType>" + Environment.NewLine);
						sbNew.Append("\t<Message>" + (item.Message != null ? item.Message : "NULL") + "</Message>" + Environment.NewLine);
		...
		/// <returns>The completed LogSystemCollection object.</returns>
		public static LogSystemCollection LoadFromXML(string xml)
		{
			LogSystemCollection coll = new LogSystemCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			...
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				...
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					...
					LogSystem item = LogSystem.LoadFromXML(node.OuterXml);
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this._disposed)
			{
				...
				if (disposing)
				{
					...
					KeyedCollection = new Dictionary<long, LogSystem>();
	...
	#endregion LogSystem Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for LogSystem event args such as population
	/// </summary>
	[Serializable]
	public class LogSystem_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private LogSystemCollection _coll = new LogSystemCollection();

		/// <summary>
		/// Creates a new LogSystem_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public LogSystem_GetCollection_EventArgs(int currentIndex, int totalCount, LogSystemCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty LogSystem_GetCollection_EventArgs.
		/// </summary>
		public LogSystem_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public LogSystemCollection LogSystemCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a LogSystemCollection asynchronously.
	/// </summary>
	public class LogSystemCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private LogSystemCollection _coll = new LogSystemCollection();
		...
		/// <summary>
		/// Creates a new LogSystem_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public LogSystemCollection_GetAsyncObject(int currentIndex, int totalCount, LogSystemCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
