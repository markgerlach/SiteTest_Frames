...
namespace LEAD
{
		...
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		private ContactPhone _originalValues = null;
		...
		/// <summary>
		/// Builds a ContactPhonebased on a certain record from the database.
		/// </summary>
		/// <param name="phoneID">A primary key used to select the record.</param>
		public ContactPhone(long phoneID)
		{
			this.Get(phoneID);
		...
		/// <summary>
		/// Property generated from the iPhoneID field.
		/// </summary>
		public long PhoneID
		{
			get 
			...
			set 
			{
				if (_phoneID != value)
				{
					bool cancelled = NotifyPropertyChanging("PhoneID", _phoneID, value);
					if (!cancelled)
					{
						_phoneID = value;
						SetModifiedStatus("PhoneID");
						NotifyPropertyChanged("PhoneID", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPhoneType field.
		/// </summary>
		public string PhoneType
		{
			...
			set 
			{
				if (_phoneType != value)
				{
					bool cancelled = NotifyPropertyChanging("PhoneType", _phoneType, value);
					if (!cancelled)
					{
						_phoneType = value;
						SetModifiedStatus("PhoneType");
						NotifyPropertyChanged("PhoneType", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPhoneNum field.
		/// </summary>
		public string PhoneNum
		{
			...
			set 
			{
				if (_phoneNum != value)
				{
					bool cancelled = NotifyPropertyChanging("PhoneNum", _phoneNum, value);
					if (!cancelled)
					{
						_phoneNum = value;
						SetModifiedStatus("PhoneNum");
						NotifyPropertyChanged("PhoneNum", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// A ContactPhone with all of this object's original values.
		/// </summary>
		[Newtonsoft.Json.JsonIgnore]
		public ContactPhone OriginalValues
		{
		...
		public void SetBaseRules()
		{
			...
			this.Rules.Add(new PropertyRequiredCustomRule("PhoneID", "The \"Phone ID\" field is required in the ContactPhone record.", RecordStatus.Modified));
			this.Rules.Add(new PropertyRequiredCustomRule("AgencyID", "The \"Agency ID\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("ContactID", "The \"Contact ID\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Default", "The \"Default\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Inactive", "The \"Inactive\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateAdded", "The \"Date Added\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateUpdated", "The \"Date Updated\" field is required in the ContactPhone record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Rowversion", "The \"Rowversion\" field is required in the ContactPhone record.", RecordStatus.Modified));

			// Max Length Rules
			this.Rules.Add(new MaxLengthCustomRule("PhoneType", 50, "The maximum length for the \"PhoneType\" field is 50 characters."));
			this.Rules.Add(new MaxLengthCustomRule("PhoneNum", 50, "The maximum length for the \"PhoneNum\" field is 50 characters."));
		...
		{
			ContactPhone item = base.CloneObjectWithIL<ContactPhone>(this);
		...
		public ClassGenExceptionCollection RefreshObject(int threshHoldInMinutes)
		{
			...
			if (((TimeSpan)currentTime.Subtract(_dateTimeObjectPopulated.Value)).TotalMinutes > threshHoldInMinutes)
			{
				...
				errors.AddRange(this.Get(_phoneID));
			}
		...
		public ClassGenExceptionCollection RefreshForce()
		{
			...
			if (!String.IsNullOrEmpty(this._phoneID.ToString()))
			{
				errors.AddRange(this.Get(_phoneID));	// Just do a get on the object
			}
			else
			{
		...
		public override void UndoChanges()
		{
			...
			_phoneID = _originalValues.PhoneID;
			_agencyID = _originalValues.AgencyID;
			_contactID = _originalValues.ContactID;
			_phoneType = _originalValues.PhoneType;
			_phoneNum = _originalValues.PhoneNum;
		...
		public ClassGenExceptionCollection AddUpdate(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			if (_recordStatus == RecordStatus.Deleted)
			{
				try
				{
					...
					errors.AddRange(LEAD_BaseObject.DeleteImmediate("tContactPhone", "iPhoneID", _phoneID.ToString(), true));
				}
				catch (SqlException sqle) { errors.Add(new ClassGenException(sqle)); }
				catch (Exception ex) { errors.Add(new ClassGenException(ex)); }
			...
			if (_recordStatus == RecordStatus.New || _recordStatus == RecordStatus.Modified)
			{
				...
				{
					byte[] timeStampFromTable = DAL.GetTimeStampFromTable("tContactPhone", "bRowversion",
						"iPhoneID = " + this.PhoneID + "");
				...
				try
				{
					...
					sql = "DECLARE @return_val BIGINT " + 
						"IF NOT EXISTS (SELECT iPhoneID FROM tContactPhone WHERE iPhoneID = @piPhoneID) " + 
						"BEGIN" + 
						"    INSERT INTO tContactPhone (iAgencyID, iContactID, sPhoneType, sPhoneNum, bDefault, dtInactivated, bInactive, sAddedByUser, dtUpdated, sUpdatedByUser) " + 
						"    SELECT @piAgencyID, @piContactID, @psPhoneType, @psPhoneNum, @pbDefault, @pdtInactivated, @pbInactive, @psAddedByUser, @pdtUpdated, @psUpdatedByUser " + 
						"    SELECT @return_val = SCOPE_IDENTITY() " + 
						"END " + 
						"ELSE " + 
						"BEGIN " + 
						"    UPDATE tContactPhone SET " + 
						"        iAgencyID = @piAgencyID" + 
						"        ,iContactID = @piContactID" + 
						"        ,bDefault = @pbDefault" + 
						"        ,bInactive = @pbInactive" + 
						"        ,dtUpdated = @pdtUpdated" + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PhoneType")) ? "        ,sPhoneType = @psPhoneType" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PhoneNum")) ? "        ,sPhoneNum = @psPhoneNum" : "") + 
						...
						"     WHERE iPhoneID = @piPhoneID " + 
						"     SELECT @return_val = @piPhoneID " + 
						"END; SELECT @return_val AS ret_val, bRowversion FROM tContactPhone WHERE iPhoneID = @return_val";
					cmd = new SqlCommand(sql);

					cmd.Parameters.Add("@piPhoneID", SqlDbType.BigInt).Value = _phoneID;
					...
					cmd.Parameters.Add("@psPhoneType", SqlDbType.VarChar, 50).Value = (_phoneType == null ? (object)DBNull.Value : (object)_phoneType);
					cmd.Parameters.Add("@psPhoneNum", SqlDbType.VarChar, 50).Value = (_phoneNum == null ? (object)DBNull.Value : (object)_phoneNum);
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						long oldRecID = _phoneID;

						_phoneID = (long)row["ret_val"];
		...
		/// </summary>
		/// <param name="phoneID">A key field used to find the correct record.</param>
		/// <param name="includeParentPopulation">Whether or not to include values derived from a parent table.</param>
		public ClassGenExceptionCollection Get(long phoneID, bool includeParentPopulation)
		{
			ClassGenExceptionCollection errors = new ClassGenExceptionCollection();
			SqlCommand cmd = null;
			string sql = string.Empty;
			...
			try
			{
				sql = "SELECT [CP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tContactPhone [CP] " + 
					"WHERE [CP].[iPhoneID] = @piPhoneID " + 
					"";
				cmd = new SqlCommand(sql);
				cmd.Parameters.Add("@piPhoneID", SqlDbType.BigInt).Value = phoneID;
		...
		public ClassGenExceptionCollection Get(long phoneID)
		{
			return Get(phoneID, false);		// Get the item
		}
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_phoneID = long.Parse(row["iPhoneID"] != DBNull.Value ? row["iPhoneID"].ToString() : "0");
				...
				_phoneType = (row["sPhoneType"] != DBNull.Value ? _phoneType = row["sPhoneType"].ToString() : null);
				_phoneNum = (row["sPhoneNum"] != DBNull.Value ? _phoneNum = row["sPhoneNum"].ToString() : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<ContactPhone>(this, dt);
		}
		...
		// Main Class - ContactPhone

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PhoneID = "PhoneID";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PhoneType = "PhoneType";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PhoneNum = "PhoneNum";
		...
		public static string GetDBFieldName(ContactPhoneField field)
		{
			...
			switch (field)
			{
				case ContactPhoneField.PhoneID: fldName = "iPhoneID"; break;
				case ContactPhoneField.AgencyID: fldName = "iAgencyID"; break;
				case ContactPhoneField.ContactID: fldName = "iContactID"; break;
				case ContactPhoneField.PhoneType: fldName = "sPhoneType"; break;
				case ContactPhoneField.PhoneNum: fldName = "sPhoneNum"; break;
				case ContactPhoneField.Default: fldName = "bDefault"; break;
				case ContactPhoneField.DateInactivated: fldName = "dtInactivated"; break;
				case ContactPhoneField.Inactive: fldName = "bInactive"; break;
				case ContactPhoneField.DateAdded: fldName = "dtAdded"; break;
				case ContactPhoneField.AddedByUser: fldName = "sAddedByUser"; break;
				case ContactPhoneField.DateUpdated: fldName = "dtUpdated"; break;
				case ContactPhoneField.UpdatedByUser: fldName = "sUpdatedByUser"; break;
				case ContactPhoneField.Rowversion: fldName = "bRowversion"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "iphoneid") { fldName = ContactPhoneField.PhoneID.ToString(); }
			else if (field.ToLower() == "iagencyid") { fldName = ContactPhoneField.AgencyID.ToString(); }
			else if (field.ToLower() == "icontactid") { fldName = ContactPhoneField.ContactID.ToString(); }
			else if (field.ToLower() == "sphonetype") { fldName = ContactPhoneField.PhoneType.ToString(); }
			else if (field.ToLower() == "sphonenum") { fldName = ContactPhoneField.PhoneNum.ToString(); }
			else if (field.ToLower() == "bdefault") { fldName = ContactPhoneField.Default.ToString(); }
			else if (field.ToLower() == "dtinactivated") { fldName = ContactPhoneField.DateInactivated.ToString(); }
			else if (field.ToLower() == "binactive") { fldName = ContactPhoneField.Inactive.ToString(); }
			else if (field.ToLower() == "dtadded") { fldName = ContactPhoneField.DateAdded.ToString(); }
			else if (field.ToLower() == "saddedbyuser") { fldName = ContactPhoneField.AddedByUser.ToString(); }
			else if (field.ToLower() == "dtupdated") { fldName = ContactPhoneField.DateUpdated.ToString(); }
			else if (field.ToLower() == "supdatedbyuser") { fldName = ContactPhoneField.UpdatedByUser.ToString(); }
			else if (field.ToLower() == "browversion") { fldName = ContactPhoneField.Rowversion.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "tContactPhone"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(ContactPhoneField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(ContactPhoneField field, string whereClause)
		{
		...
		public static DataTable GetDistinctFromDBAsDataTable(ContactPhoneField[] fields, 
			string[] fieldAliases,
			ContactPhoneField[] sortedFields, 
			string whereClause)
		{
			Dictionary<ContactPhoneField, string> fieldNames = new Dictionary<ContactPhoneField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (ContactPhoneField fld in fields)
			{
			...
			Dictionary<ContactPhoneField, string> sortedFieldNames = new Dictionary<ContactPhoneField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (ContactPhoneField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(ContactPhoneMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(ContactPhoneMinMaxDateField field, string whereClause)
		{
			ContactPhoneField fld = (ContactPhoneField)Enum.Parse(typeof(ContactPhoneField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(ContactPhoneMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(ContactPhoneMinMaxDateField field, string whereClause)
		{
			ContactPhoneField fld = (ContactPhoneField)Enum.Parse(typeof(ContactPhoneField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(ContactPhoneMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(ContactPhoneMinMaxNumberField field, string whereClause)
		{
			ContactPhoneField fld = (ContactPhoneField)Enum.Parse(typeof(ContactPhoneField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(ContactPhoneMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(ContactPhoneMinMaxNumberField field, string whereClause)
		{
			ContactPhoneField fld = (ContactPhoneField)Enum.Parse(typeof(ContactPhoneField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static ContactPhone CopyFrom(ContactPhone source)
		{
			// Make the copy of the object
			ContactPhone item = source.Clone();
		...
		public static string ToDBFriendly(string dbString)
		{
			...
			rtv = rtv.Replace("[PhoneID]", "[iPhoneID]");
			rtv = rtv.Replace("[AgencyID]", "[iAgencyID]");
			rtv = rtv.Replace("[ContactID]", "[iContactID]");
			rtv = rtv.Replace("[PhoneType]", "[sPhoneType]");
			rtv = rtv.Replace("[PhoneNum]", "[sPhoneNum]");
		...
		/// <summary>
		/// Attempt to serialize the ContactPhone object to the server
		/// </summary>
		/// <param name="obj">The ContactPhone object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(ContactPhone obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the ContactPhone object from the server
		/// </summary>
		/// <param name="obj">The ContactPhone object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A ContactPhone object containing the return from the method</returns>
		public static ContactPhone DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			ContactPhone rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<ContactPhone>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<PhoneID>" + System.Security.SecurityElement.Escape(PhoneID.ToString()) + "</PhoneID>" + Environment.NewLine);
			...
			sb.Append("<PhoneType>" + System.Security.SecurityElement.Escape(PhoneType) + "</PhoneType>" + Environment.NewLine);
			sb.Append("<PhoneNum>" + System.Security.SecurityElement.Escape(PhoneNum) + "</PhoneNum>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<ContactPhone>" + Environment.NewLine);
				sb.Append("</ContactPhone>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			if (_originalValues.PhoneID != PhoneID)
			{
				sb.Append("\t<PhoneID>");
				sb.Append("<OldValue>" + _originalValues.PhoneID.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + PhoneID.ToString() + "</NewValue>");
				sb.Append("</PhoneID>" + Environment.NewLine);
			}
			...
			if (_originalValues.PhoneType != PhoneType)
			{
				sb.Append("\t<PhoneType>");
				sb.Append("<OldValue>" + _originalValues.PhoneType + "</OldValue>");
				sb.Append("<NewValue>" + PhoneType + "</NewValue>");
				sb.Append("</PhoneType>" + Environment.NewLine);
			}
			if (_originalValues.PhoneNum != PhoneNum)
			{
				sb.Append("\t<PhoneNum>");
				sb.Append("<OldValue>" + _originalValues.PhoneNum + "</OldValue>");
				sb.Append("<NewValue>" + PhoneNum + "</NewValue>");
				sb.Append("</PhoneNum>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new ContactPhone object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new ContactPhone object.</returns>
		public static ContactPhone LoadFromXML(string xml)
		{
			...
			foreach (System.Xml.XmlNode child in doc.ChildNodes[0].ChildNodes)
			{
				...
				switch (child.Name)
				{
					case "PhoneID": item.PhoneID = long.Parse(child.InnerText); break;
					...
					case "PhoneType": item.PhoneType = child.InnerText; break;
					case "PhoneNum": item.PhoneNum = child.InnerText; break;
	...
	#endregion ContactPhone Class

	#region ContactPhoneField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum ContactPhoneField
	{
		/// <summary>
		/// The PhoneID element.
		/// </summary>
		...
		ContactID,
		/// <summary>
		/// The PhoneType element.
		/// </summary>
		PhoneType,
		/// <summary>
		/// The PhoneNum element.
		/// </summary>
		PhoneNum,
		/// <summary>
		/// The Default element.
	...
	#endregion ContactPhoneField Enum

	#region ContactPhoneMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum ContactPhoneMinMaxDateField
	{
		/// <summary>
		/// The DateInactivated element.
		/// </summary>
	...
	#endregion ContactPhoneMinMaxDateField Enum

	#region ContactPhoneMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum ContactPhoneMinMaxNumberField
	{
		/// <summary>
		/// The PhoneID element.
		/// </summary>
	...
	#endregion ContactPhoneMinMaxNumberField Enum

	#region ContactPhone Collection
	/// <summary>
	/// A collection for ContactPhone objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with ContactPhone objects.
	/// Most of the functionality is in this class, including the methods for creating ContactPhone objects from a database.
	/// </remarks>
	[Serializable]
	public partial class ContactPhoneCollection : ClassGenBindingList<ContactPhone, long>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated, IClassGenClassUpdatable
	{
		...
		/// </summary>
		public ContactPhoneCollection() 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "PhoneID";
		...
		public ContactPhoneCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "PhoneID";
		...
		public ContactPhoneCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "PhoneID";
		...
		/// </summary>
		/// <param name="phoneID">A key field used to find the correct record.</param>
		/// <returns>The ContactPhone object that matches the given value.</returns>
		public ContactPhone Get(long phoneID)
		{
			ContactPhone val = null;
			if (KeyedCollection.ContainsKey(phoneID)) { val = KeyedCollection[phoneID]; }
			return val;
		}
		...
		/// <returns>A ContactPhoneCollection of matching records.</returns>
		public ContactPhoneCollection GetByContactID(long contactID)
		{
			ContactPhoneCollection coll = new ContactPhoneCollection();
			if (FKKeyedCollection.ContainsKey("ContactID"))
			{
				List<ContactPhone> list = new List<ContactPhone>();
				if (FKKeyedCollection["ContactID"].ContainsKey(contactID))
				{
					list = FKKeyedCollection["ContactID"][contactID];
				}
				foreach (ContactPhone item in list)
				{
					coll.Add(item);
				}
			}
		...
		/// </summary>
		public new ContactPhoneCollection ActiveRecords
		{
			get
			{
				return (ContactPhoneCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public ContactPhoneCollection DeletedRecords
		{
			get
			{
				return (ContactPhoneCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public ContactPhoneCollection ModifiedRecords
		{
			get
			{
				return (ContactPhoneCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public ContactPhoneCollection NewRecords
		{
			get
			{
				return (ContactPhoneCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = ContactPhoneCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = ContactPhoneCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [CP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tContactPhone [CP] " + 
				...
				this.OnMasterPopulate("ContactPhone", "Retrieving Full List Of ContactPhones", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("ContactPhone", 
						"Populating ContactPhone: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
					...
					if (this.Contains(item.PhoneID)) { this.Remove(item.PhoneID); }
		...
		public ClassGenExceptionCollection AddUpdateAll(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			try
			{
				...
				{
					this.OnDetailDelete("ContactPhone",
						"Deleting ContactPhone: " + (this.Count - i + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						this.Count - i + 1);
					ContactPhone item = this[i];
					if (item.RecordStatus == RecordStatus.Deleted)
					{
						...
						else
						{
							...
							{
								err.RecordIndex = i + 1;
								err.RecordKey = item.PhoneID.ToString();
							}
				...
				// Update Method
				int count = 0;
				foreach (ContactPhone item in this)
				{
					this.OnDetailUpdate("ContactPhone",
						"Updating ContactPhone: " + (count + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						count + 1);
		...
		public new ContactPhoneCollection Clone()
		{
			ContactPhoneCollection newColl = new ContactPhoneCollection();
		...
		/// </summary>
		/// <returns>A new ContactPhoneCollection.</returns>
		public new ContactPhoneCollection CopyWithNewIDs()
		{
			return (ContactPhoneCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.ContactPhoneField field)
		{
			...
			switch (field)
			{
				case LEAD.ContactPhoneField.PhoneID:
					foreach (ContactPhone item in this)
					{
						if (!String.IsNullOrEmpty(item.PhoneID.ToString()) && 
							!vals.ContainsKey(item.PhoneID.ToString().Trim())) { vals.Add(item.PhoneID.ToString().Trim(), item.PhoneID.ToString().Trim()); }
					}
					break;
				case LEAD.ContactPhoneField.AgencyID:
					foreach (ContactPhone item in this)
					{
					...
					break;
				case LEAD.ContactPhoneField.ContactID:
					foreach (ContactPhone item in this)
					{
					...
					break;
				case LEAD.ContactPhoneField.PhoneType:
					foreach (ContactPhone item in this)
					{
						if (!String.IsNullOrEmpty(item.PhoneType) && 
							!vals.ContainsKey(item.PhoneType.Trim())) { vals.Add(item.PhoneType.Trim(), item.PhoneType.Trim()); }
					}
					break;
				case LEAD.ContactPhoneField.PhoneNum:
					foreach (ContactPhone item in this)
					{
						if (!String.IsNullOrEmpty(item.PhoneNum) && 
							!vals.ContainsKey(item.PhoneNum.Trim())) { vals.Add(item.PhoneNum.Trim(), item.PhoneNum.Trim()); }
					}
					break;
				case LEAD.ContactPhoneField.AddedByUser:
					foreach (ContactPhone item in this)
					{
					...
					break;
				case LEAD.ContactPhoneField.UpdatedByUser:
					foreach (ContactPhone item in this)
					{
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (ContactPhone item in this.ActiveRecords)
				{
					...
					if (exCollection.Count > 0)
					{
						foreach (ClassGenException ex in exCollection)
						{
							...
							ex.RecordKey = item.PhoneID.ToString();
						}
		...
		/// </summary>
		/// <returns>A ContactPhoneCollection of current records.</returns>
		public ContactPhoneCollection GetCurrent()
		{
		...
		public bool Exists(long phoneID)
		{
			return (this.Exists(new Predicate<ContactPhone>(delegate (ContactPhone obj) 
				{ return obj.PhoneID == phoneID; })));
		}
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<ContactPhone>();
		}
		...
		/// <summary>
		/// Attempt to serialize the ContactPhoneCollection object to the server
		/// </summary>
		/// <param name="obj">The ContactPhoneCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(ContactPhoneCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the ContactPhoneCollection object from the server
		/// </summary>
		/// <param name="obj">The ContactPhoneCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A ContactPhoneCollection object containing the return from the method</returns>
		public static ContactPhoneCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			ContactPhoneCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<ContactPhoneCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#ContactPhone') IS NOT NULL  DROP TABLE #ContactPhone; " + 
					"CREATE TABLE #ContactPhone (iPhoneID bigint, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #ContactPhone (iPhoneID) SELECT iPhoneID FROM tContactPhone" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #ContactPhone "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				ContactPhoneCollection_GetAsyncObject obj = (ContactPhoneCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.ContactPhoneCollection);
			}
		}
			...
			int pageSize)
		{
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [CP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tContactPhone [CP] " + 
					"INNER JOIN #ContactPhone TEMP ON [CP].[iPhoneID] = [TEMP].[iPhoneID] " +
				...
				// Populate the local ContactPhone collection
				coll = new ContactPhoneCollection();
				foreach (DataRow row in dt.Rows)
				{
				...
				// Report the progress
				ContactPhoneCollection_GetAsyncObject obj = new ContactPhoneCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, ContactPhone_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, ContactPhoneCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (ContactPhone a in coll)
				{
					this.Add(a);		// Add the ContactPhone
				}

				ContactPhone_GetCollection_EventArgs e = new ContactPhone_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<ContactPhoneCollection>" + Environment.NewLine);
			sb.Append("</ContactPhoneCollection>" + Environment.NewLine);
			...
			foreach (ContactPhone item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<ContactPhone>" + Environment.NewLine);
						sbRead.Append("\t<PhoneID>" + item.PhoneID.ToString() + "</PhoneID>" + Environment.NewLine);
						...
						sbRead.Append("\t<PhoneType>" + (item.PhoneType != null ? item.PhoneType : "NULL") + "</PhoneType>" + Environment.NewLine);
						sbRead.Append("\t<PhoneNum>" + (item.PhoneNum != null ? item.PhoneNum : "NULL") + "</PhoneNum>" + Environment.NewLine);
						sbRead.Append("</ContactPhone>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<ContactPhone>" + Environment.NewLine);
						sbDeleted.Append("\t<PhoneID>" + item.PhoneID.ToString() + "</PhoneID>" + Environment.NewLine);
						...
						sbDeleted.Append("\t<PhoneType>" + (item.PhoneType != null ? item.PhoneType : "NULL") + "</PhoneType>" + Environment.NewLine);
						sbDeleted.Append("\t<PhoneNum>" + (item.PhoneNum != null ? item.PhoneNum : "NULL") + "</PhoneNum>" + Environment.NewLine);
						sbDeleted.Append("</ContactPhone>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<ContactPhone>" + Environment.NewLine);
						sbNew.Append("\t<PhoneID>" + item.PhoneID.ToString() + "</PhoneID>" + Environment.NewLine);
						...
						sbNew.Append("\t<PhoneType>" + (item.PhoneType != null ? item.PhoneType : "NULL") + "</PhoneType>" + Environment.NewLine);
						sbNew.Append("\t<PhoneNum>" + (item.PhoneNum != null ? item.PhoneNum : "NULL") + "</PhoneNum>" + Environment.NewLine);
						sbNew.Append("</ContactPhone>" + Environment.NewLine);
		...
		/// <returns>The completed ContactPhoneCollection object.</returns>
		public static ContactPhoneCollection LoadFromXML(string xml)
		{
			ContactPhoneCollection coll = new ContactPhoneCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			...
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				...
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					...
					ContactPhone item = ContactPhone.LoadFromXML(node.OuterXml);
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this._disposed)
			{
				...
				if (disposing)
				{
					...
					KeyedCollection = new Dictionary<long, ContactPhone>();

					FKKeyedCollection = new Dictionary<string, Dictionary<object, List<ContactPhone>>>();
	...
	#endregion ContactPhone Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for ContactPhone event args such as population
	/// </summary>
	[Serializable]
	public class ContactPhone_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private ContactPhoneCollection _coll = new ContactPhoneCollection();

		/// <summary>
		/// Creates a new ContactPhone_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public ContactPhone_GetCollection_EventArgs(int currentIndex, int totalCount, ContactPhoneCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty ContactPhone_GetCollection_EventArgs.
		/// </summary>
		public ContactPhone_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public ContactPhoneCollection ContactPhoneCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a ContactPhoneCollection asynchronously.
	/// </summary>
	public class ContactPhoneCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private ContactPhoneCollection _coll = new ContactPhoneCollection();
		...
		/// <summary>
		/// Creates a new ContactPhone_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public ContactPhoneCollection_GetAsyncObject(int currentIndex, int totalCount, ContactPhoneCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
