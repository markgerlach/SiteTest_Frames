...
{
	/// <summary>
	/// Class Name: Search_Personnel_EthnicityCount
	/// Generated by GenClasses v.4.0.0 on 07/28/2017 05:18 AM
	/// </summary>
	#region Search_Personnel_EthnicityCount Class
	[Serializable]
	public partial class Search_Personnel_EthnicityCount : LEAD_BaseObject, 
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		/// <summary>
		/// Creates a new Search_Personnel_EthnicityCount.
		/// </summary>
		public Search_Personnel_EthnicityCount()
		{
		...
		public Search_Personnel_EthnicityCount Clone()
		{
			Search_Personnel_EthnicityCount item = base.CloneObjectWithIL<Search_Personnel_EthnicityCount>(this);
		...
		public object CopyWithNewID()
		{
			...
			Search_Personnel_EthnicityCount item = this.Clone();
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<Search_Personnel_EthnicityCount>(this, dt);
		}
		...
		// Main Class - Search_Personnel_EthnicityCount
		...
		public static string GetDBFieldName(Search_Personnel_EthnicityCountField field)
		{
			...
			switch (field)
			{
				case Search_Personnel_EthnicityCountField.RecGUID: fldName = "sRecGUID"; break;
				case Search_Personnel_EthnicityCountField.Ethnicity: fldName = "sEthnicity"; break;
				case Search_Personnel_EthnicityCountField.Count: fldName = "iCount"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "srecguid") { fldName = Search_Personnel_EthnicityCountField.RecGUID.ToString(); }
			else if (field.ToLower() == "sethnicity") { fldName = Search_Personnel_EthnicityCountField.Ethnicity.ToString(); }
			else if (field.ToLower() == "icount") { fldName = Search_Personnel_EthnicityCountField.Count.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "vwSearch_Personnel_EthnicityCount"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_EthnicityCountField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_EthnicityCountField field, string whereClause)
		{
			...
			try
			{
				sql = "SELECT DISTINCT LTRIM(RTRIM([" + fldName + "])) " +
						"FROM [vwSearch_Personnel_EthnicityCount] " +
		...
		public static DataTable GetDistinctFromDBAsDataTable(Search_Personnel_EthnicityCountField[] fields, 
			string[] fieldAliases,
			Search_Personnel_EthnicityCountField[] sortedFields, 
			string whereClause)
		{
			Dictionary<Search_Personnel_EthnicityCountField, string> fieldNames = new Dictionary<Search_Personnel_EthnicityCountField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (Search_Personnel_EthnicityCountField fld in fields)
			{
			...
			Dictionary<Search_Personnel_EthnicityCountField, string> sortedFieldNames = new Dictionary<Search_Personnel_EthnicityCountField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (Search_Personnel_EthnicityCountField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(Search_Personnel_EthnicityCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(Search_Personnel_EthnicityCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_EthnicityCountField fld = (Search_Personnel_EthnicityCountField)Enum.Parse(typeof(Search_Personnel_EthnicityCountField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(Search_Personnel_EthnicityCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(Search_Personnel_EthnicityCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_EthnicityCountField fld = (Search_Personnel_EthnicityCountField)Enum.Parse(typeof(Search_Personnel_EthnicityCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(Search_Personnel_EthnicityCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(Search_Personnel_EthnicityCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_EthnicityCountField fld = (Search_Personnel_EthnicityCountField)Enum.Parse(typeof(Search_Personnel_EthnicityCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(Search_Personnel_EthnicityCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(Search_Personnel_EthnicityCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_EthnicityCountField fld = (Search_Personnel_EthnicityCountField)Enum.Parse(typeof(Search_Personnel_EthnicityCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static Search_Personnel_EthnicityCount CopyFrom(Search_Personnel_EthnicityCount source)
		{
			// Make the copy of the object
			Search_Personnel_EthnicityCount item = source.Clone();
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_EthnicityCount object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_EthnicityCount object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_EthnicityCount obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_EthnicityCount object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_EthnicityCount object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_EthnicityCount object containing the return from the method</returns>
		public static Search_Personnel_EthnicityCount DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_EthnicityCount rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_EthnicityCount>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			{
				sb.Insert(0, "<Search_Personnel_EthnicityCount>" + Environment.NewLine);
				sb.Append("</Search_Personnel_EthnicityCount>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new Search_Personnel_EthnicityCount object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new Search_Personnel_EthnicityCount object.</returns>
		public static Search_Personnel_EthnicityCount LoadFromXML(string xml)
		{
			Search_Personnel_EthnicityCount item = new Search_Personnel_EthnicityCount();
	...
	#endregion Search_Personnel_EthnicityCount Class

	#region Search_Personnel_EthnicityCountField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum Search_Personnel_EthnicityCountField
	{
		/// <summary>
		/// The RecGUID element.
		/// </summary>
	...
	#endregion Search_Personnel_EthnicityCountField Enum

	#region Search_Personnel_EthnicityCountMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_EthnicityCountMinMaxDateField
	{
	}
	#endregion Search_Personnel_EthnicityCountMinMaxDateField Enum

	#region Search_Personnel_EthnicityCountMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_EthnicityCountMinMaxNumberField
	{
		/// <summary>
		/// The Count element.
		/// </summary>
	...
	#endregion Search_Personnel_EthnicityCountMinMaxNumberField Enum

	#region Search_Personnel_EthnicityCount Collection
	/// <summary>
	/// A collection for Search_Personnel_EthnicityCount objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with Search_Personnel_EthnicityCount objects.
	/// Most of the functionality is in this class, including the methods for creating Search_Personnel_EthnicityCount objects from a database.
	/// </remarks>
	[Serializable]
	public partial class Search_Personnel_EthnicityCountCollection : ClassGenBindingList<Search_Personnel_EthnicityCount, string>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated
	{
		...
		/// </summary>
		public Search_Personnel_EthnicityCountCollection() 
		{
		...
		public Search_Personnel_EthnicityCountCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		public Search_Personnel_EthnicityCountCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		/// <returns>The Search_Personnel_EthnicityCount that matches the given value for the recGUID property.</returns>
		public Search_Personnel_EthnicityCount Get(string recGUID)
		{
			Search_Personnel_EthnicityCount val = null;
		...
		/// </summary>
		public new Search_Personnel_EthnicityCountCollection ActiveRecords
		{
			get
			{
				return (Search_Personnel_EthnicityCountCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public Search_Personnel_EthnicityCountCollection DeletedRecords
		{
			get
			{
				return (Search_Personnel_EthnicityCountCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public Search_Personnel_EthnicityCountCollection ModifiedRecords
		{
			get
			{
				return (Search_Personnel_EthnicityCountCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public Search_Personnel_EthnicityCountCollection NewRecords
		{
			get
			{
				return (Search_Personnel_EthnicityCountCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = Search_Personnel_EthnicityCountCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = Search_Personnel_EthnicityCountCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [SPEC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_EthnicityCount [SPEC] " + 
				...
				this.OnMasterPopulate("Search_Personnel_EthnicityCount", "Retrieving Full List Of Search_Personnel_EthnicityCounts", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("Search_Personnel_EthnicityCount", 
						"Populating Search_Personnel_EthnicityCount: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
		...
		public new Search_Personnel_EthnicityCountCollection Clone()
		{
			Search_Personnel_EthnicityCountCollection newColl = new Search_Personnel_EthnicityCountCollection();
		...
		/// </summary>
		/// <returns>A new Search_Personnel_EthnicityCountCollection.</returns>
		public new Search_Personnel_EthnicityCountCollection CopyWithNewIDs()
		{
			return (Search_Personnel_EthnicityCountCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.Search_Personnel_EthnicityCountField field)
		{
			...
			switch (field)
			{
				case LEAD.Search_Personnel_EthnicityCountField.RecGUID:
					foreach (Search_Personnel_EthnicityCount item in this)
					{
						if (!String.IsNullOrEmpty(item.RecGUID) && 
							!vals.ContainsKey(item.RecGUID.Trim())) { vals.Add(item.RecGUID.Trim(), item.RecGUID.Trim()); }
					}
					break;
				case LEAD.Search_Personnel_EthnicityCountField.Ethnicity:
					foreach (Search_Personnel_EthnicityCount item in this)
					{
					...
					break;
				case LEAD.Search_Personnel_EthnicityCountField.Count:
					foreach (Search_Personnel_EthnicityCount item in this)
					{
						if (item.Count != null &&
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (Search_Personnel_EthnicityCount item in this.ActiveRecords)
				{
		...
		/// </summary>
		/// <returns>A Search_Personnel_EthnicityCountCollection of current records.</returns>
		public Search_Personnel_EthnicityCountCollection GetCurrent()
		{
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<Search_Personnel_EthnicityCount>();
		}
		...
		public static int Delete(string whereClause, ref ClassGenExceptionCollection errors)
		{
			...
			try
			{
				sql = "DELETE FROM vwSearch_Personnel_EthnicityCount " +
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_EthnicityCountCollection object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_EthnicityCountCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_EthnicityCountCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_EthnicityCountCollection object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_EthnicityCountCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_EthnicityCountCollection object containing the return from the method</returns>
		public static Search_Personnel_EthnicityCountCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_EthnicityCountCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_EthnicityCountCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#Search_Personnel_EthnicityCount') IS NOT NULL  DROP TABLE #Search_Personnel_EthnicityCount; " + 
					"CREATE TABLE #Search_Personnel_EthnicityCount (sRecGUID uniqueidentifier, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #Search_Personnel_EthnicityCount (sRecGUID) SELECT sRecGUID FROM vwSearch_Personnel_EthnicityCount" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #Search_Personnel_EthnicityCount "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				Search_Personnel_EthnicityCountCollection_GetAsyncObject obj = (Search_Personnel_EthnicityCountCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.Search_Personnel_EthnicityCountCollection);
			}
		}
			...
			int pageSize)
		{
			...
			Search_Personnel_EthnicityCountCollection coll = new Search_Personnel_EthnicityCountCollection();
			Search_Personnel_EthnicityCount item = new Search_Personnel_EthnicityCount();
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [SPEC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_EthnicityCount [SPEC] " + 
					"INNER JOIN #Search_Personnel_EthnicityCount TEMP ON [SPEC].[sRecGUID] = [TEMP].[sRecGUID] " +
				...
				// Populate the local Search_Personnel_EthnicityCount collection
				coll = new Search_Personnel_EthnicityCountCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new Search_Personnel_EthnicityCount();
					item.Get(row);
					coll.Add(item);
				}
				...
				// Report the progress
				Search_Personnel_EthnicityCountCollection_GetAsyncObject obj = new Search_Personnel_EthnicityCountCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, Search_Personnel_EthnicityCount_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, Search_Personnel_EthnicityCountCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (Search_Personnel_EthnicityCount a in coll)
				{
					this.Add(a);		// Add the Search_Personnel_EthnicityCount
				}

				Search_Personnel_EthnicityCount_GetCollection_EventArgs e = new Search_Personnel_EthnicityCount_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<Search_Personnel_EthnicityCountCollection>" + Environment.NewLine);
			sb.Append("</Search_Personnel_EthnicityCountCollection>" + Environment.NewLine);
			...
			foreach (Search_Personnel_EthnicityCount item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<Search_Personnel_EthnicityCount>" + Environment.NewLine);
						sbRead.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbRead.Append("\t<Ethnicity>" + (item.Ethnicity != null ? item.Ethnicity : "NULL") + "</Ethnicity>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<Search_Personnel_EthnicityCount>" + Environment.NewLine);
						sbDeleted.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbDeleted.Append("\t<Ethnicity>" + (item.Ethnicity != null ? item.Ethnicity : "NULL") + "</Ethnicity>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<Search_Personnel_EthnicityCount>" + Environment.NewLine);
						sbNew.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbNew.Append("\t<Ethnicity>" + (item.Ethnicity != null ? item.Ethnicity : "NULL") + "</Ethnicity>" + Environment.NewLine);
		...
		/// <returns>The completed Search_Personnel_EthnicityCountCollection object.</returns>
		public static Search_Personnel_EthnicityCountCollection LoadFromXML(string xml)
		{
			Search_Personnel_EthnicityCountCollection coll = new Search_Personnel_EthnicityCountCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			// <Search_Personnel_EthnicityCountCollection>
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				// <Search_Personnel_EthnicityCount>
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					// These are the elements <DetailGUID>, <UserName>, etc.
					Search_Personnel_EthnicityCount item = Search_Personnel_EthnicityCount.LoadFromXML(node.OuterXml);
	...
	#endregion Search_Personnel_EthnicityCount Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for Search_Personnel_EthnicityCount event args such as population
	/// </summary>
	[Serializable]
	public class Search_Personnel_EthnicityCount_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private Search_Personnel_EthnicityCountCollection _coll = new Search_Personnel_EthnicityCountCollection();

		/// <summary>
		/// Creates a new Search_Personnel_EthnicityCount_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public Search_Personnel_EthnicityCount_GetCollection_EventArgs(int currentIndex, int totalCount, Search_Personnel_EthnicityCountCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty Search_Personnel_EthnicityCount_GetCollection_EventArgs.
		/// </summary>
		public Search_Personnel_EthnicityCount_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public Search_Personnel_EthnicityCountCollection Search_Personnel_EthnicityCountCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a Search_Personnel_EthnicityCountCollection asynchronously.
	/// </summary>
	public class Search_Personnel_EthnicityCountCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private Search_Personnel_EthnicityCountCollection _coll = new Search_Personnel_EthnicityCountCollection();
		...
		/// <summary>
		/// Creates a new Search_Personnel_EthnicityCount_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public Search_Personnel_EthnicityCountCollection_GetAsyncObject(int currentIndex, int totalCount, Search_Personnel_EthnicityCountCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
