...
namespace LEAD
{
	...
	/// </summary>
	#region Search_Personnel_GenderCount Class
	[Serializable]
	public partial class Search_Personnel_GenderCount : LEAD_BaseObject, 
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		/// <summary>
		/// Creates a new Search_Personnel_GenderCount.
		/// </summary>
		public Search_Personnel_GenderCount()
		{
		...
		public Search_Personnel_GenderCount Clone()
		{
			Search_Personnel_GenderCount item = base.CloneObjectWithIL<Search_Personnel_GenderCount>(this);
		...
		public object CopyWithNewID()
		{
			...
			Search_Personnel_GenderCount item = this.Clone();
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<Search_Personnel_GenderCount>(this, dt);
		}
		...
		// Main Class - Search_Personnel_GenderCount
		...
		public static string GetDBFieldName(Search_Personnel_GenderCountField field)
		{
			...
			switch (field)
			{
				case Search_Personnel_GenderCountField.RecGUID: fldName = "sRecGUID"; break;
				case Search_Personnel_GenderCountField.Gender: fldName = "sGender"; break;
				case Search_Personnel_GenderCountField.Count: fldName = "iCount"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "srecguid") { fldName = Search_Personnel_GenderCountField.RecGUID.ToString(); }
			else if (field.ToLower() == "sgender") { fldName = Search_Personnel_GenderCountField.Gender.ToString(); }
			else if (field.ToLower() == "icount") { fldName = Search_Personnel_GenderCountField.Count.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "vwSearch_Personnel_GenderCount"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_GenderCountField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_GenderCountField field, string whereClause)
		{
			...
			try
			{
				sql = "SELECT DISTINCT LTRIM(RTRIM([" + fldName + "])) " +
						"FROM [vwSearch_Personnel_GenderCount] " +
		...
		public static DataTable GetDistinctFromDBAsDataTable(Search_Personnel_GenderCountField[] fields, 
			string[] fieldAliases,
			Search_Personnel_GenderCountField[] sortedFields, 
			string whereClause)
		{
			Dictionary<Search_Personnel_GenderCountField, string> fieldNames = new Dictionary<Search_Personnel_GenderCountField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (Search_Personnel_GenderCountField fld in fields)
			{
			...
			Dictionary<Search_Personnel_GenderCountField, string> sortedFieldNames = new Dictionary<Search_Personnel_GenderCountField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (Search_Personnel_GenderCountField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(Search_Personnel_GenderCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(Search_Personnel_GenderCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_GenderCountField fld = (Search_Personnel_GenderCountField)Enum.Parse(typeof(Search_Personnel_GenderCountField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(Search_Personnel_GenderCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(Search_Personnel_GenderCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_GenderCountField fld = (Search_Personnel_GenderCountField)Enum.Parse(typeof(Search_Personnel_GenderCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(Search_Personnel_GenderCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(Search_Personnel_GenderCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_GenderCountField fld = (Search_Personnel_GenderCountField)Enum.Parse(typeof(Search_Personnel_GenderCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(Search_Personnel_GenderCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(Search_Personnel_GenderCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_GenderCountField fld = (Search_Personnel_GenderCountField)Enum.Parse(typeof(Search_Personnel_GenderCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static Search_Personnel_GenderCount CopyFrom(Search_Personnel_GenderCount source)
		{
			// Make the copy of the object
			Search_Personnel_GenderCount item = source.Clone();
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_GenderCount object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_GenderCount object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_GenderCount obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_GenderCount object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_GenderCount object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_GenderCount object containing the return from the method</returns>
		public static Search_Personnel_GenderCount DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_GenderCount rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_GenderCount>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			{
				sb.Insert(0, "<Search_Personnel_GenderCount>" + Environment.NewLine);
				sb.Append("</Search_Personnel_GenderCount>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new Search_Personnel_GenderCount object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new Search_Personnel_GenderCount object.</returns>
		public static Search_Personnel_GenderCount LoadFromXML(string xml)
		{
			Search_Personnel_GenderCount item = new Search_Personnel_GenderCount();
	...
	#endregion Search_Personnel_GenderCount Class

	#region Search_Personnel_GenderCountField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum Search_Personnel_GenderCountField
	{
		/// <summary>
		/// The RecGUID element.
		/// </summary>
	...
	#endregion Search_Personnel_GenderCountField Enum

	#region Search_Personnel_GenderCountMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_GenderCountMinMaxDateField
	{
	}
	#endregion Search_Personnel_GenderCountMinMaxDateField Enum

	#region Search_Personnel_GenderCountMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_GenderCountMinMaxNumberField
	{
		/// <summary>
		/// The Count element.
		/// </summary>
	...
	#endregion Search_Personnel_GenderCountMinMaxNumberField Enum

	#region Search_Personnel_GenderCount Collection
	/// <summary>
	/// A collection for Search_Personnel_GenderCount objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with Search_Personnel_GenderCount objects.
	/// Most of the functionality is in this class, including the methods for creating Search_Personnel_GenderCount objects from a database.
	/// </remarks>
	[Serializable]
	public partial class Search_Personnel_GenderCountCollection : ClassGenBindingList<Search_Personnel_GenderCount, string>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated
	{
		...
		/// </summary>
		public Search_Personnel_GenderCountCollection() 
		{
		...
		public Search_Personnel_GenderCountCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		public Search_Personnel_GenderCountCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		/// <returns>The Search_Personnel_GenderCount that matches the given value for the recGUID property.</returns>
		public Search_Personnel_GenderCount Get(string recGUID)
		{
			Search_Personnel_GenderCount val = null;
		...
		/// </summary>
		public new Search_Personnel_GenderCountCollection ActiveRecords
		{
			get
			{
				return (Search_Personnel_GenderCountCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public Search_Personnel_GenderCountCollection DeletedRecords
		{
			get
			{
				return (Search_Personnel_GenderCountCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public Search_Personnel_GenderCountCollection ModifiedRecords
		{
			get
			{
				return (Search_Personnel_GenderCountCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public Search_Personnel_GenderCountCollection NewRecords
		{
			get
			{
				return (Search_Personnel_GenderCountCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = Search_Personnel_GenderCountCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = Search_Personnel_GenderCountCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [SPGC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_GenderCount [SPGC] " + 
				...
				this.OnMasterPopulate("Search_Personnel_GenderCount", "Retrieving Full List Of Search_Personnel_GenderCounts", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("Search_Personnel_GenderCount", 
						"Populating Search_Personnel_GenderCount: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
		...
		public new Search_Personnel_GenderCountCollection Clone()
		{
			Search_Personnel_GenderCountCollection newColl = new Search_Personnel_GenderCountCollection();
		...
		/// </summary>
		/// <returns>A new Search_Personnel_GenderCountCollection.</returns>
		public new Search_Personnel_GenderCountCollection CopyWithNewIDs()
		{
			return (Search_Personnel_GenderCountCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.Search_Personnel_GenderCountField field)
		{
			...
			switch (field)
			{
				case LEAD.Search_Personnel_GenderCountField.RecGUID:
					foreach (Search_Personnel_GenderCount item in this)
					{
						if (!String.IsNullOrEmpty(item.RecGUID) && 
							!vals.ContainsKey(item.RecGUID.Trim())) { vals.Add(item.RecGUID.Trim(), item.RecGUID.Trim()); }
					}
					break;
				case LEAD.Search_Personnel_GenderCountField.Gender:
					foreach (Search_Personnel_GenderCount item in this)
					{
					...
					break;
				case LEAD.Search_Personnel_GenderCountField.Count:
					foreach (Search_Personnel_GenderCount item in this)
					{
						if (item.Count != null &&
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (Search_Personnel_GenderCount item in this.ActiveRecords)
				{
		...
		/// </summary>
		/// <returns>A Search_Personnel_GenderCountCollection of current records.</returns>
		public Search_Personnel_GenderCountCollection GetCurrent()
		{
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<Search_Personnel_GenderCount>();
		}
		...
		public static int Delete(string whereClause, ref ClassGenExceptionCollection errors)
		{
			...
			try
			{
				sql = "DELETE FROM vwSearch_Personnel_GenderCount " +
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_GenderCountCollection object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_GenderCountCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_GenderCountCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_GenderCountCollection object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_GenderCountCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_GenderCountCollection object containing the return from the method</returns>
		public static Search_Personnel_GenderCountCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_GenderCountCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_GenderCountCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#Search_Personnel_GenderCount') IS NOT NULL  DROP TABLE #Search_Personnel_GenderCount; " + 
					"CREATE TABLE #Search_Personnel_GenderCount (sRecGUID uniqueidentifier, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #Search_Personnel_GenderCount (sRecGUID) SELECT sRecGUID FROM vwSearch_Personnel_GenderCount" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #Search_Personnel_GenderCount "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				Search_Personnel_GenderCountCollection_GetAsyncObject obj = (Search_Personnel_GenderCountCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.Search_Personnel_GenderCountCollection);
			}
		}
			...
			int pageSize)
		{
			...
			Search_Personnel_GenderCountCollection coll = new Search_Personnel_GenderCountCollection();
			Search_Personnel_GenderCount item = new Search_Personnel_GenderCount();
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [SPGC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_GenderCount [SPGC] " + 
					"INNER JOIN #Search_Personnel_GenderCount TEMP ON [SPGC].[sRecGUID] = [TEMP].[sRecGUID] " +
				...
				// Populate the local Search_Personnel_GenderCount collection
				coll = new Search_Personnel_GenderCountCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new Search_Personnel_GenderCount();
					item.Get(row);
					coll.Add(item);
				}
				...
				// Report the progress
				Search_Personnel_GenderCountCollection_GetAsyncObject obj = new Search_Personnel_GenderCountCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, Search_Personnel_GenderCount_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, Search_Personnel_GenderCountCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (Search_Personnel_GenderCount a in coll)
				{
					this.Add(a);		// Add the Search_Personnel_GenderCount
				}

				Search_Personnel_GenderCount_GetCollection_EventArgs e = new Search_Personnel_GenderCount_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<Search_Personnel_GenderCountCollection>" + Environment.NewLine);
			sb.Append("</Search_Personnel_GenderCountCollection>" + Environment.NewLine);
			...
			foreach (Search_Personnel_GenderCount item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<Search_Personnel_GenderCount>" + Environment.NewLine);
						sbRead.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbRead.Append("\t<Gender>" + (item.Gender != null ? item.Gender : "NULL") + "</Gender>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<Search_Personnel_GenderCount>" + Environment.NewLine);
						sbDeleted.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbDeleted.Append("\t<Gender>" + (item.Gender != null ? item.Gender : "NULL") + "</Gender>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<Search_Personnel_GenderCount>" + Environment.NewLine);
						sbNew.Append("\t<RecGUID>" + (item.RecGUID != null ? item.RecGUID : "NULL") + "</RecGUID>" + Environment.NewLine);
						sbNew.Append("\t<Gender>" + (item.Gender != null ? item.Gender : "NULL") + "</Gender>" + Environment.NewLine);
		...
		/// <returns>The completed Search_Personnel_GenderCountCollection object.</returns>
		public static Search_Personnel_GenderCountCollection LoadFromXML(string xml)
		{
			Search_Personnel_GenderCountCollection coll = new Search_Personnel_GenderCountCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			// <Search_Personnel_GenderCountCollection>
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				// <Search_Personnel_GenderCount>
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					// These are the elements <DetailGUID>, <UserName>, etc.
					Search_Personnel_GenderCount item = Search_Personnel_GenderCount.LoadFromXML(node.OuterXml);
	...
	#endregion Search_Personnel_GenderCount Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for Search_Personnel_GenderCount event args such as population
	/// </summary>
	[Serializable]
	public class Search_Personnel_GenderCount_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private Search_Personnel_GenderCountCollection _coll = new Search_Personnel_GenderCountCollection();

		/// <summary>
		/// Creates a new Search_Personnel_GenderCount_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public Search_Personnel_GenderCount_GetCollection_EventArgs(int currentIndex, int totalCount, Search_Personnel_GenderCountCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty Search_Personnel_GenderCount_GetCollection_EventArgs.
		/// </summary>
		public Search_Personnel_GenderCount_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public Search_Personnel_GenderCountCollection Search_Personnel_GenderCountCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a Search_Personnel_GenderCountCollection asynchronously.
	/// </summary>
	public class Search_Personnel_GenderCountCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private Search_Personnel_GenderCountCollection _coll = new Search_Personnel_GenderCountCollection();
		...
		/// <summary>
		/// Creates a new Search_Personnel_GenderCount_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public Search_Personnel_GenderCountCollection_GetAsyncObject(int currentIndex, int totalCount, Search_Personnel_GenderCountCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
