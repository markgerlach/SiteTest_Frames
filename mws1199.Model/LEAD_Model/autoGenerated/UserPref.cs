...
namespace LEAD
{
	...
	/// </summary>
	#region UserPref Class
	[Serializable]
	public partial class UserPref : LEAD_BaseObject, 
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		private string _prefValueString = null;
		private long? _prefValueLong = null;
		private bool _prefValueBool = false;
		private DateTime? _dtPrefValue = null;
		private string _prefXMLData = null;
		private string _prefXMLSchema = null;
		...
		private UserPref _originalValues = null;
		...
		/// <summary>
		/// Builds a UserPrefbased on a certain record from the database.
		/// </summary>
		/// <param name="propID">A primary key used to select the record.</param>
		public UserPref(long propID)
		{
			this.Get(propID);
		...
		/// <summary>
		/// Property generated from the iPropID field.
		/// </summary>
		public long PropID
		{
			get 
			...
			set 
			{
				if (_propID != value)
				{
					bool cancelled = NotifyPropertyChanging("PropID", _propID, value);
					if (!cancelled)
					{
						_propID = value;
						SetModifiedStatus("PropID");
						NotifyPropertyChanged("PropID", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPrefKey field.
		/// </summary>
		public string PrefKey
		{
			...
			set 
			{
				if (_prefKey != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefKey", _prefKey, value);
					if (!cancelled)
					{
						_prefKey = value;
						SetModifiedStatus("PrefKey");
						NotifyPropertyChanged("PrefKey", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPrefValue field.
		/// </summary>
		public string PrefValueString
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
			...
			set 
			{
				if (_prefValueString != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefValueString", _prefValueString, value);
					if (!cancelled)
					{
						_prefValueString = value;
						SetModifiedStatus("PrefValueString");
						NotifyPropertyChanged("PrefValueString", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the iPrefValue field.
		/// </summary>
		public long? PrefValueLong
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
				return _prefValueLong;
			}
			set 
			{
				if (_prefValueLong != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefValueLong", _prefValueLong, value);
					if (!cancelled)
					{
						_prefValueLong = value;
						SetModifiedStatus("PrefValueLong");
						NotifyPropertyChanged("PrefValueLong", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the bPrefValue field.
		/// </summary>
		public bool PrefValueBool
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
				return _prefValueBool;
			}
			set 
			{
				if (_prefValueBool != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefValueBool", _prefValueBool, value);
					if (!cancelled)
					{
						_prefValueBool = value;
						SetModifiedStatus("PrefValueBool");
						NotifyPropertyChanged("PrefValueBool", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// The value of PrefValueBool rendered as a string.
		/// </summary>
		public string PrefValueBoolAsString
		{
			get { return _prefValueBool.ToString(); }
		}

		/// <summary>
		/// Property generated from the dtPrefValue field.
		/// </summary>
		public DateTime? DatePrefValue
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
			...
			set 
			{
				if (_dtPrefValue != value)
				{
					bool cancelled = NotifyPropertyChanging("DatePrefValue", _dtPrefValue, value);
					if (!cancelled)
					{
						_dtPrefValue = value;
						SetModifiedStatus("DatePrefValue");
						NotifyPropertyChanged("DatePrefValue", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPrefXMLData field.
		/// </summary>
		public string PrefXMLData
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
			...
			set 
			{
				if (_prefXMLData != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefXMLData", _prefXMLData, value);
					if (!cancelled)
					{
						_prefXMLData = value;
						SetModifiedStatus("PrefXMLData");
						NotifyPropertyChanged("PrefXMLData", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sPrefXMLSchema field.
		/// </summary>
		public string PrefXMLSchema
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
				return _prefXMLSchema;
			}
			set 
			{
				if (_prefXMLSchema != value)
				{
					bool cancelled = NotifyPropertyChanging("PrefXMLSchema", _prefXMLSchema, value);
					if (!cancelled)
					{
						_prefXMLSchema = value;
						SetModifiedStatus("PrefXMLSchema");
						NotifyPropertyChanged("PrefXMLSchema", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// A UserPref with all of this object's original values.
		/// </summary>
		[Newtonsoft.Json.JsonIgnore]
		public UserPref OriginalValues
		{
		...
		public void SetBaseRules()
		{
			...
			this.Rules.Add(new PropertyRequiredCustomRule("PropID", "The \"Prop ID\" field is required in the UserPref record.", RecordStatus.Modified));
			this.Rules.Add(new PropertyRequiredCustomRule("AgencyID", "The \"Agency ID\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("UserID", "The \"User ID\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("PrefValueBool", "The \"Pref Value Bool\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Inactive", "The \"Inactive\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateAdded", "The \"Date Added\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateUpdated", "The \"Date Updated\" field is required in the UserPref record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Rowversion", "The \"Rowversion\" field is required in the UserPref record.", RecordStatus.Modified));

			// Max Length Rules
			this.Rules.Add(new MaxLengthCustomRule("PrefKey", 50, "The maximum length for the \"PrefKey\" field is 50 characters."));
			this.Rules.Add(new MaxLengthCustomRule("PrefValueString", 5000, "The maximum length for the \"PrefValueString\" field is 5000 characters."));
			...
			// Date Range Rules
			this.Rules.Add(new MinValueCustomRule<DateTime>("DatePrefValue", DateTime.Parse("1/1/1900"), "The date value entered must be after 1/1/1900 for the \"DatePrefValue\" field."));
			this.Rules.Add(new MaxValueCustomRule<DateTime>("DatePrefValue", DateTime.Parse("12/31/2299"), "The date value entered must be before 12/31/2299 for the \"DatePrefValue\" field."));
		...
		public UserPref Clone()
		{
			UserPref item = base.CloneObjectWithIL<UserPref>(this);
		...
		public ClassGenExceptionCollection RefreshObject(int threshHoldInMinutes)
		{
			...
			if (((TimeSpan)currentTime.Subtract(_dateTimeObjectPopulated.Value)).TotalMinutes > threshHoldInMinutes)
			{
				...
				errors.AddRange(this.Get(_propID));
			}
		...
		public ClassGenExceptionCollection RefreshForce()
		{
			...
			if (!String.IsNullOrEmpty(this._propID.ToString()))
			{
				errors.AddRange(this.Get(_propID));	// Just do a get on the object
			}
			else
			{
		...
		public override void UndoChanges()
		{
			...
			_propID = _originalValues.PropID;
			_agencyID = _originalValues.AgencyID;
			_userID = _originalValues.UserID;
			_prefKey = _originalValues.PrefKey;
			_prefValueString = _originalValues.PrefValueString;
			_prefValueLong = _originalValues.PrefValueLong;
			_prefValueBool = _originalValues.PrefValueBool;
			_dtPrefValue = _originalValues.DatePrefValue;
			_prefXMLData = _originalValues.PrefXMLData;
			_prefXMLSchema = _originalValues.PrefXMLSchema;
		...
		public ClassGenExceptionCollection AddUpdate(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			if (_recordStatus == RecordStatus.Deleted)
			{
				try
				{
					...
					errors.AddRange(LEAD_BaseObject.DeleteImmediate("tUserPref", "iPropID", _propID.ToString(), true));
				}
				catch (SqlException sqle) { errors.Add(new ClassGenException(sqle)); }
				catch (Exception ex) { errors.Add(new ClassGenException(ex)); }
			...
			if (_recordStatus == RecordStatus.New || _recordStatus == RecordStatus.Modified)
			{
				...
				{
					byte[] timeStampFromTable = DAL.GetTimeStampFromTable("tUserPref", "bRowversion",
						"iPropID = " + this.PropID + "");
				...
				try
				{
					...
					sql = "DECLARE @return_val BIGINT " + 
						"IF NOT EXISTS (SELECT iPropID FROM tUserPref WHERE iPropID = @piPropID) " + 
						"BEGIN" + 
						"    INSERT INTO tUserPref (iAgencyID, iUserID, sPrefKey, sPrefValue, iPrefValue, bPrefValue, dtPrefValue, sPrefXMLData, sPrefXMLSchema, bInactive, sAddedByUser, dtUpdated, sUpdatedByUser) " + 
						"    SELECT @piAgencyID, @piUserID, @psPrefKey, @psPrefValue, @piPrefValue, @pbPrefValue, @pdtPrefValue, @psPrefXMLData, @psPrefXMLSchema, @pbInactive, @psAddedByUser, @pdtUpdated, @psUpdatedByUser " + 
						"    SELECT @return_val = SCOPE_IDENTITY() " + 
						"END " + 
						"ELSE " + 
						"BEGIN " + 
						"    UPDATE tUserPref SET " + 
						"        iAgencyID = @piAgencyID" + 
						"        ,iUserID = @piUserID" + 
						"        ,bPrefValue = @pbPrefValue" + 
						"        ,bInactive = @pbInactive" + 
						"        ,dtUpdated = @pdtUpdated" + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PrefKey")) ? "        ,sPrefKey = @psPrefKey" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PrefValueString")) ? "        ,sPrefValue = @psPrefValue" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PrefValueLong")) ? "        ,iPrefValue = @piPrefValue" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("DatePrefValue")) ? "        ,dtPrefValue = @pdtPrefValue" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PrefXMLData")) ? "        ,sPrefXMLData = @psPrefXMLData" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PrefXMLSchema")) ? "        ,sPrefXMLSchema = @psPrefXMLSchema" : "") + 
						...
						"     WHERE iPropID = @piPropID " + 
						"     SELECT @return_val = @piPropID " + 
						"END; SELECT @return_val AS ret_val, bRowversion FROM tUserPref WHERE iPropID = @return_val";
					cmd = new SqlCommand(sql);

					cmd.Parameters.Add("@piPropID", SqlDbType.BigInt).Value = _propID;
					cmd.Parameters.Add("@piAgencyID", SqlDbType.BigInt).Value = _agencyID;
					cmd.Parameters.Add("@piUserID", SqlDbType.BigInt).Value = _userID;
					cmd.Parameters.Add("@psPrefKey", SqlDbType.VarChar, 50).Value = (_prefKey == null ? (object)DBNull.Value : (object)_prefKey);
					cmd.Parameters.Add("@psPrefValue", SqlDbType.VarChar, 5000).Value = (_prefValueString == null ? (object)DBNull.Value : (object)_prefValueString);
					cmd.Parameters.Add("@piPrefValue", SqlDbType.BigInt).Value = (_prefValueLong == null ? (object)DBNull.Value : (object)_prefValueLong);
					cmd.Parameters.Add("@pbPrefValue", SqlDbType.Bit).Value = _prefValueBool;
					cmd.Parameters.Add("@pdtPrefValue", SqlDbType.DateTime).Value = (_dtPrefValue == null ? (object)DBNull.Value : (object)_dtPrefValue);
					cmd.Parameters.Add("@psPrefXMLData", SqlDbType.Text).Value = (_prefXMLData == null ? (object)DBNull.Value : (object)_prefXMLData);
					cmd.Parameters.Add("@psPrefXMLSchema", SqlDbType.Text).Value = (_prefXMLSchema == null ? (object)DBNull.Value : (object)_prefXMLSchema);
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						long oldRecID = _propID;

						_propID = (long)row["ret_val"];
		...
		/// </summary>
		/// <param name="propID">A key field used to find the correct record.</param>
		/// <param name="includeParentPopulation">Whether or not to include values derived from a parent table.</param>
		public ClassGenExceptionCollection Get(long propID, bool includeParentPopulation)
		{
			ClassGenExceptionCollection errors = new ClassGenExceptionCollection();
			SqlCommand cmd = null;
			string sql = string.Empty;
			...
			try
			{
				sql = "SELECT [UP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserPref [UP] " + 
					"WHERE [UP].[iPropID] = @piPropID " + 
					"";
				cmd = new SqlCommand(sql);
				cmd.Parameters.Add("@piPropID", SqlDbType.BigInt).Value = propID;
		...
		public ClassGenExceptionCollection Get(long propID)
		{
			return Get(propID, false);		// Get the item
		}
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_propID = long.Parse(row["iPropID"] != DBNull.Value ? row["iPropID"].ToString() : "0");
				...
				_prefKey = (row["sPrefKey"] != DBNull.Value ? _prefKey = row["sPrefKey"].ToString() : null);
				_prefValueString = (row["sPrefValue"] != DBNull.Value ? _prefValueString = row["sPrefValue"].ToString() : null);
				
				_prefValueLong = (row["iPrefValue"] != DBNull.Value ? _prefValueLong = long.Parse(row["iPrefValue"].ToString()) : null);
				_prefValueBool = bool.Parse(row["bPrefValue"] != DBNull.Value ? row["bPrefValue"].ToString() : "false");
				_dtPrefValue = (row["dtPrefValue"] != DBNull.Value ? _dtPrefValue = (DateTime)row["dtPrefValue"] : null);
				_prefXMLData = (row["sPrefXMLData"] != DBNull.Value ? _prefXMLData = row["sPrefXMLData"].ToString() : null);
				_prefXMLSchema = (row["sPrefXMLSchema"] != DBNull.Value ? _prefXMLSchema = row["sPrefXMLSchema"].ToString() : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<UserPref>(this, dt);
		}
		...
		/// </summary>
		public static readonly string FN_PropID = "PropID";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefKey = "PrefKey";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefValueString = "PrefValueString";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefValueLong = "PrefValueLong";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefValueBool = "PrefValueBool";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_DatePrefValue = "DatePrefValue";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefXMLData = "PrefXMLData";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_PrefXMLSchema = "PrefXMLSchema";
		...
		public static string GetDBFieldName(UserPrefField field)
		{
			...
			switch (field)
			{
				case UserPrefField.PropID: fldName = "iPropID"; break;
				case UserPrefField.AgencyID: fldName = "iAgencyID"; break;
				case UserPrefField.UserID: fldName = "iUserID"; break;
				case UserPrefField.PrefKey: fldName = "sPrefKey"; break;
				case UserPrefField.PrefValueString: fldName = "sPrefValue"; break;
				case UserPrefField.PrefValueLong: fldName = "iPrefValue"; break;
				case UserPrefField.PrefValueBool: fldName = "bPrefValue"; break;
				case UserPrefField.DatePrefValue: fldName = "dtPrefValue"; break;
				case UserPrefField.PrefXMLData: fldName = "sPrefXMLData"; break;
				case UserPrefField.PrefXMLSchema: fldName = "sPrefXMLSchema"; break;
				case UserPrefField.Inactive: fldName = "bInactive"; break;
				case UserPrefField.DateAdded: fldName = "dtAdded"; break;
				case UserPrefField.AddedByUser: fldName = "sAddedByUser"; break;
				case UserPrefField.DateUpdated: fldName = "dtUpdated"; break;
				case UserPrefField.UpdatedByUser: fldName = "sUpdatedByUser"; break;
				case UserPrefField.Rowversion: fldName = "bRowversion"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "ipropid") { fldName = UserPrefField.PropID.ToString(); }
			else if (field.ToLower() == "iagencyid") { fldName = UserPrefField.AgencyID.ToString(); }
			else if (field.ToLower() == "iuserid") { fldName = UserPrefField.UserID.ToString(); }
			else if (field.ToLower() == "sprefkey") { fldName = UserPrefField.PrefKey.ToString(); }
			else if (field.ToLower() == "sprefvalue") { fldName = UserPrefField.PrefValueString.ToString(); }
			else if (field.ToLower() == "iprefvalue") { fldName = UserPrefField.PrefValueLong.ToString(); }
			else if (field.ToLower() == "bprefvalue") { fldName = UserPrefField.PrefValueBool.ToString(); }
			else if (field.ToLower() == "dtprefvalue") { fldName = UserPrefField.DatePrefValue.ToString(); }
			else if (field.ToLower() == "sprefxmldata") { fldName = UserPrefField.PrefXMLData.ToString(); }
			else if (field.ToLower() == "sprefxmlschema") { fldName = UserPrefField.PrefXMLSchema.ToString(); }
			else if (field.ToLower() == "binactive") { fldName = UserPrefField.Inactive.ToString(); }
			else if (field.ToLower() == "dtadded") { fldName = UserPrefField.DateAdded.ToString(); }
			else if (field.ToLower() == "saddedbyuser") { fldName = UserPrefField.AddedByUser.ToString(); }
			else if (field.ToLower() == "dtupdated") { fldName = UserPrefField.DateUpdated.ToString(); }
			else if (field.ToLower() == "supdatedbyuser") { fldName = UserPrefField.UpdatedByUser.ToString(); }
			else if (field.ToLower() == "browversion") { fldName = UserPrefField.Rowversion.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "tUserPref"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(UserPrefField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(UserPrefField field, string whereClause)
		{
		...
		public static DataTable GetDistinctFromDBAsDataTable(UserPrefField[] fields, 
			string[] fieldAliases,
			UserPrefField[] sortedFields, 
			string whereClause)
		{
			Dictionary<UserPrefField, string> fieldNames = new Dictionary<UserPrefField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (UserPrefField fld in fields)
			{
			...
			Dictionary<UserPrefField, string> sortedFieldNames = new Dictionary<UserPrefField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (UserPrefField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(UserPrefMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(UserPrefMinMaxDateField field, string whereClause)
		{
			UserPrefField fld = (UserPrefField)Enum.Parse(typeof(UserPrefField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(UserPrefMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(UserPrefMinMaxDateField field, string whereClause)
		{
			UserPrefField fld = (UserPrefField)Enum.Parse(typeof(UserPrefField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(UserPrefMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(UserPrefMinMaxNumberField field, string whereClause)
		{
			UserPrefField fld = (UserPrefField)Enum.Parse(typeof(UserPrefField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(UserPrefMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(UserPrefMinMaxNumberField field, string whereClause)
		{
			UserPrefField fld = (UserPrefField)Enum.Parse(typeof(UserPrefField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static UserPref CopyFrom(UserPref source)
		{
			// Make the copy of the object
			UserPref item = source.Clone();
		...
		public static string ToDBFriendly(string dbString)
		{
			...
			rtv = rtv.Replace("[PropID]", "[iPropID]");
			rtv = rtv.Replace("[AgencyID]", "[iAgencyID]");
			rtv = rtv.Replace("[UserID]", "[iUserID]");
			rtv = rtv.Replace("[PrefKey]", "[sPrefKey]");
			rtv = rtv.Replace("[PrefValueString]", "[sPrefValue]");
			rtv = rtv.Replace("[PrefValueLong]", "[iPrefValue]");
			rtv = rtv.Replace("[PrefValueBool]", "[bPrefValue]");
			rtv = rtv.Replace("[DatePrefValue]", "[dtPrefValue]");
			rtv = rtv.Replace("[PrefXMLData]", "[sPrefXMLData]");
			rtv = rtv.Replace("[PrefXMLSchema]", "[sPrefXMLSchema]");
		...
		/// <summary>
		/// Attempt to serialize the UserPref object to the server
		/// </summary>
		/// <param name="obj">The UserPref object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(UserPref obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the UserPref object from the server
		/// </summary>
		/// <param name="obj">The UserPref object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A UserPref object containing the return from the method</returns>
		public static UserPref DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			UserPref rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<UserPref>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<PropID>" + System.Security.SecurityElement.Escape(PropID.ToString()) + "</PropID>" + Environment.NewLine);
			...
			sb.Append("<PrefKey>" + System.Security.SecurityElement.Escape(PrefKey) + "</PrefKey>" + Environment.NewLine);
			sb.Append("<PrefValueString>" + System.Security.SecurityElement.Escape(PrefValueString) + "</PrefValueString>" + Environment.NewLine);
			sb.Append("<PrefValueLong>" + System.Security.SecurityElement.Escape(PrefValueLong.ToString()) + "</PrefValueLong>" + Environment.NewLine);
			sb.Append("<PrefValueBool>" + System.Security.SecurityElement.Escape(PrefValueBool.ToString()) + "</PrefValueBool>" + Environment.NewLine);
			if (DatePrefValue.HasValue)
			{
				sb.Append("<DatePrefValue>" + DatePrefValue.Value.ToString("MM/dd/yyyy hh:mm:ss.ffffff tt") + "</DatePrefValue>" + Environment.NewLine);
			}
			sb.Append("<PrefXMLData>" + System.Security.SecurityElement.Escape(PrefXMLData) + "</PrefXMLData>" + Environment.NewLine);
			sb.Append("<PrefXMLSchema>" + System.Security.SecurityElement.Escape(PrefXMLSchema) + "</PrefXMLSchema>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<UserPref>" + Environment.NewLine);
				sb.Append("</UserPref>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			if (_originalValues.PropID != PropID)
			{
				sb.Append("\t<PropID>");
				sb.Append("<OldValue>" + _originalValues.PropID.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + PropID.ToString() + "</NewValue>");
				sb.Append("</PropID>" + Environment.NewLine);
			}
			...
			if (_originalValues.PrefKey != PrefKey)
			{
				sb.Append("\t<PrefKey>");
				sb.Append("<OldValue>" + _originalValues.PrefKey + "</OldValue>");
				sb.Append("<NewValue>" + PrefKey + "</NewValue>");
				sb.Append("</PrefKey>" + Environment.NewLine);
			}
			if (_originalValues.PrefValueString != PrefValueString)
			{
				sb.Append("\t<PrefValueString>");
				sb.Append("<OldValue>" + _originalValues.PrefValueString + "</OldValue>");
				sb.Append("<NewValue>" + PrefValueString + "</NewValue>");
				sb.Append("</PrefValueString>" + Environment.NewLine);
			}
			if (_originalValues.PrefValueLong != PrefValueLong)
			{
				sb.Append("\t<PrefValueLong>");
				sb.Append("<OldValue>" + _originalValues.PrefValueLong.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + PrefValueLong.ToString() + "</NewValue>");
				sb.Append("</PrefValueLong>" + Environment.NewLine);
			}
			if (_originalValues.PrefValueBool != PrefValueBool)
			{
				sb.Append("\t<PrefValueBool>");
				sb.Append("<OldValue>" + _originalValues.PrefValueBool.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + PrefValueBool.ToString() + "</NewValue>");
				sb.Append("</PrefValueBool>" + Environment.NewLine);
			}
			if (_originalValues.DatePrefValue != DatePrefValue)
			{
				sb.Append("\t<DatePrefValue>");
				sb.Append("<OldValue>" + _originalValues.DatePrefValue.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + DatePrefValue.ToString() + "</NewValue>");
				sb.Append("</DatePrefValue>" + Environment.NewLine);
			}
			if (_originalValues.PrefXMLData != PrefXMLData)
			{
				sb.Append("\t<PrefXMLData>");
				sb.Append("<OldValue>" + _originalValues.PrefXMLData + "</OldValue>");
				sb.Append("<NewValue>" + PrefXMLData + "</NewValue>");
				sb.Append("</PrefXMLData>" + Environment.NewLine);
			}
			if (_originalValues.PrefXMLSchema != PrefXMLSchema)
			{
				sb.Append("\t<PrefXMLSchema>");
				sb.Append("<OldValue>" + _originalValues.PrefXMLSchema + "</OldValue>");
				sb.Append("<NewValue>" + PrefXMLSchema + "</NewValue>");
				sb.Append("</PrefXMLSchema>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new UserPref object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new UserPref object.</returns>
		public static UserPref LoadFromXML(string xml)
		{
			UserPref item = new UserPref();
			...
			foreach (System.Xml.XmlNode child in doc.ChildNodes[0].ChildNodes)
			{
				...
				switch (child.Name)
				{
					case "PropID": item.PropID = long.Parse(child.InnerText); break;
					case "AgencyID": item.AgencyID = long.Parse(child.InnerText); break;
					case "UserID": item.UserID = long.Parse(child.InnerText); break;
					case "PrefKey": item.PrefKey = child.InnerText; break;
					case "PrefValueString": item.PrefValueString = child.InnerText; break;

					case "PrefValueLong": item.PrefValueLong = (!String.IsNullOrEmpty(child.InnerText) ? long.Parse(child.InnerText) : (long?)null); break;
					case "PrefValueBool": item.PrefValueBool = bool.Parse(child.InnerText); break;
					case "DatePrefValue": item.DatePrefValue = (!String.IsNullOrEmpty(child.InnerText) ? DateTime.Parse(child.InnerText) : (DateTime?)null); break;
					case "PrefXMLData": item.PrefXMLData = child.InnerText; break;
					case "PrefXMLSchema": item.PrefXMLSchema = child.InnerText; break;
	...
	#endregion UserPref Class

	#region UserPrefField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum UserPrefField
	{
		/// <summary>
		/// The PropID element.
		/// </summary>
		...
		PrefKey,
		/// <summary>
		/// The PrefValueString element.
		/// </summary>
		PrefValueString,
		/// <summary>
		/// The PrefValueLong element.
		/// </summary>
		PrefValueLong,
		/// <summary>
		/// The PrefValueBool element.
		/// </summary>
		PrefValueBool,
		/// <summary>
		/// The DatePrefValue element.
		/// </summary>
		DatePrefValue,
		/// <summary>
		/// The PrefXMLData element.
		/// </summary>
		PrefXMLData,
		/// <summary>
		/// The PrefXMLSchema element.
		/// </summary>
		PrefXMLSchema,
		/// <summary>
	...
	#endregion UserPrefField Enum

	#region UserPrefMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum UserPrefMinMaxDateField
	{
		/// <summary>
		/// The DatePrefValue element.
		/// </summary>
	...
	#endregion UserPrefMinMaxDateField Enum

	#region UserPrefMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum UserPrefMinMaxNumberField
	{
		/// <summary>
		/// The PropID element.
		/// </summary>
	...
	#endregion UserPrefMinMaxNumberField Enum

	#region UserPref Collection
	/// <summary>
	/// A collection for UserPref objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with UserPref objects.
	/// Most of the functionality is in this class, including the methods for creating UserPref objects from a database.
	/// </remarks>
	[Serializable]
	public partial class UserPrefCollection : ClassGenBindingList<UserPref, long>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated, IClassGenClassUpdatable
	{
		...
		public UserPrefCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "PropID";
		...
		public UserPrefCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "PropID";
		...
		/// </summary>
		/// <param name="propID">A key field used to find the correct record.</param>
		/// <returns>The UserPref object that matches the given value.</returns>
		public UserPref Get(long propID)
		{
			UserPref val = null;
			if (KeyedCollection.ContainsKey(propID)) { val = KeyedCollection[propID]; }
			return val;
		}
		...
		/// <returns>A UserPrefCollection of matching records.</returns>
		public UserPrefCollection GetByUserID(long userID)
		{
			UserPrefCollection coll = new UserPrefCollection();
		...
		/// </summary>
		public new UserPrefCollection ActiveRecords
		{
			get
			{
				return (UserPrefCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public UserPrefCollection DeletedRecords
		{
			get
			{
				return (UserPrefCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public UserPrefCollection ModifiedRecords
		{
			get
			{
				return (UserPrefCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public UserPrefCollection NewRecords
		{
			get
			{
				return (UserPrefCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = UserPrefCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = UserPrefCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [UP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserPref [UP] " + 
				...
				this.OnMasterPopulate("UserPref", "Retrieving Full List Of UserPrefs", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("UserPref", 
						"Populating UserPref: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
					...
					if (this.Contains(item.PropID)) { this.Remove(item.PropID); }
		...
		public ClassGenExceptionCollection AddUpdateAll(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			try
			{
				...
				{
					this.OnDetailDelete("UserPref",
						"Deleting UserPref: " + (this.Count - i + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						this.Count - i + 1);
					UserPref item = this[i];
					if (item.RecordStatus == RecordStatus.Deleted)
					{
						...
						else
						{
							...
							{
								err.RecordIndex = i + 1;
								err.RecordKey = item.PropID.ToString();
							}
				...
				// Update Method
				int count = 0;
				foreach (UserPref item in this)
				{
					this.OnDetailUpdate("UserPref",
						"Updating UserPref: " + (count + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						count + 1);
		...
		public new UserPrefCollection Clone()
		{
			UserPrefCollection newColl = new UserPrefCollection();
		...
		/// </summary>
		/// <returns>A new UserPrefCollection.</returns>
		public new UserPrefCollection CopyWithNewIDs()
		{
			return (UserPrefCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.UserPrefField field)
		{
			...
			switch (field)
			{
				case LEAD.UserPrefField.PropID:
					foreach (UserPref item in this)
					{
						if (!String.IsNullOrEmpty(item.PropID.ToString()) && 
							!vals.ContainsKey(item.PropID.ToString().Trim())) { vals.Add(item.PropID.ToString().Trim(), item.PropID.ToString().Trim()); }
					}
					break;
				case LEAD.UserPrefField.AgencyID:
					foreach (UserPref item in this)
					{
					...
					break;
				case LEAD.UserPrefField.UserID:
					foreach (UserPref item in this)
					{
					...
					break;
				case LEAD.UserPrefField.PrefKey:
					foreach (UserPref item in this)
					{
						if (!String.IsNullOrEmpty(item.PrefKey) && 
							!vals.ContainsKey(item.PrefKey.Trim())) { vals.Add(item.PrefKey.Trim(), item.PrefKey.Trim()); }
					}
					break;
				case LEAD.UserPrefField.PrefValueString:
					foreach (UserPref item in this)
					{
						if (!String.IsNullOrEmpty(item.PrefValueString) && 
							!vals.ContainsKey(item.PrefValueString.Trim())) { vals.Add(item.PrefValueString.Trim(), item.PrefValueString.Trim()); }
					}
					break;
				case LEAD.UserPrefField.PrefValueLong:
					foreach (UserPref item in this)
					{
						if (item.PrefValueLong != null &&
							!String.IsNullOrEmpty(item.PrefValueLong.ToString()) && 
							!vals.ContainsKey(item.PrefValueLong.ToString().Trim())) { vals.Add(item.PrefValueLong.ToString().Trim(), item.PrefValueLong.ToString().Trim()); }
					}
					break;
				case LEAD.UserPrefField.PrefXMLData:
					foreach (UserPref item in this)
					{
						if (!String.IsNullOrEmpty(item.PrefXMLData) && 
							!vals.ContainsKey(item.PrefXMLData.Trim())) { vals.Add(item.PrefXMLData.Trim(), item.PrefXMLData.Trim()); }
					}
					break;
				case LEAD.UserPrefField.PrefXMLSchema:
					foreach (UserPref item in this)
					{
						if (!String.IsNullOrEmpty(item.PrefXMLSchema) && 
							!vals.ContainsKey(item.PrefXMLSchema.Trim())) { vals.Add(item.PrefXMLSchema.Trim(), item.PrefXMLSchema.Trim()); }
					}
					break;
				case LEAD.UserPrefField.AddedByUser:
					foreach (UserPref item in this)
					{
					...
					break;
				case LEAD.UserPrefField.UpdatedByUser:
					foreach (UserPref item in this)
					{
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (UserPref item in this.ActiveRecords)
				{
					...
					if (exCollection.Count > 0)
					{
						foreach (ClassGenException ex in exCollection)
						{
							...
							ex.RecordKey = item.PropID.ToString();
						}
		...
		/// </summary>
		/// <returns>A UserPrefCollection of current records.</returns>
		public UserPrefCollection GetCurrent()
		{
		...
		public bool Exists(long propID)
		{
			return (this.Exists(new Predicate<UserPref>(delegate (UserPref obj) 
				{ return obj.PropID == propID; })));
		}
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<UserPref>();
		}
		...
		/// <summary>
		/// Attempt to serialize the UserPrefCollection object to the server
		/// </summary>
		/// <param name="obj">The UserPrefCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(UserPrefCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the UserPrefCollection object from the server
		/// </summary>
		/// <param name="obj">The UserPrefCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A UserPrefCollection object containing the return from the method</returns>
		public static UserPrefCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			UserPrefCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<UserPrefCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#UserPref') IS NOT NULL  DROP TABLE #UserPref; " + 
					"CREATE TABLE #UserPref (iPropID bigint, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #UserPref (iPropID) SELECT iPropID FROM tUserPref" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #UserPref "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				UserPrefCollection_GetAsyncObject obj = (UserPrefCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.UserPrefCollection);
			}
		}
			...
			int pageSize)
		{
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [UP].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserPref [UP] " + 
					"INNER JOIN #UserPref TEMP ON [UP].[iPropID] = [TEMP].[iPropID] " +
				...
				// Populate the local UserPref collection
				coll = new UserPrefCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new UserPref();
					item.Get(row);
				...
				// Report the progress
				UserPrefCollection_GetAsyncObject obj = new UserPrefCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, UserPref_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, UserPrefCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (UserPref a in coll)
				{
					this.Add(a);		// Add the UserPref
				}

				UserPref_GetCollection_EventArgs e = new UserPref_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<UserPrefCollection>" + Environment.NewLine);
			sb.Append("</UserPrefCollection>" + Environment.NewLine);
			...
			foreach (UserPref item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<UserPref>" + Environment.NewLine);
						sbRead.Append("\t<PropID>" + item.PropID.ToString() + "</PropID>" + Environment.NewLine);
						...
						sbRead.Append("\t<PrefKey>" + (item.PrefKey != null ? item.PrefKey : "NULL") + "</PrefKey>" + Environment.NewLine);
						sbRead.Append("\t<PrefValueString>" + (item.PrefValueString != null ? item.PrefValueString : "NULL") + "</PrefValueString>" + Environment.NewLine);
						sbRead.Append("</UserPref>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<UserPref>" + Environment.NewLine);
						sbDeleted.Append("\t<PropID>" + item.PropID.ToString() + "</PropID>" + Environment.NewLine);
						...
						sbDeleted.Append("\t<PrefKey>" + (item.PrefKey != null ? item.PrefKey : "NULL") + "</PrefKey>" + Environment.NewLine);
						sbDeleted.Append("\t<PrefValueString>" + (item.PrefValueString != null ? item.PrefValueString : "NULL") + "</PrefValueString>" + Environment.NewLine);
						sbDeleted.Append("</UserPref>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<UserPref>" + Environment.NewLine);
						sbNew.Append("\t<PropID>" + item.PropID.ToString() + "</PropID>" + Environment.NewLine);
						...
						sbNew.Append("\t<PrefKey>" + (item.PrefKey != null ? item.PrefKey : "NULL") + "</PrefKey>" + Environment.NewLine);
						sbNew.Append("\t<PrefValueString>" + (item.PrefValueString != null ? item.PrefValueString : "NULL") + "</PrefValueString>" + Environment.NewLine);
						sbNew.Append("</UserPref>" + Environment.NewLine);
		...
		/// <returns>The completed UserPrefCollection object.</returns>
		public static UserPrefCollection LoadFromXML(string xml)
		{
			UserPrefCollection coll = new UserPrefCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			...
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				...
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					...
					UserPref item = UserPref.LoadFromXML(node.OuterXml);
		...
		/// <summary>
		/// The earliest DatePrefValue present in the collection.
		/// </summary>
		public DateTime? MinOfDatePrefValue
		{
			get
			{
				DateTime? rtv = null;
				if (this.Count > 0) { rtv = this[0].DatePrefValue; }
				else { return null; }
		
				foreach (UserPref item in this)
				{
					if (item.DatePrefValue < rtv) { rtv = item.DatePrefValue; }
				}
				return rtv;
			}
		}
		...
		/// <summary>
		/// The latest DatePrefValue present in the collection.
		/// </summary>
		public DateTime? MaxOfDatePrefValue
		{
			get
			{
				DateTime? rtv = null;
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this._disposed)
			{
				...
				if (disposing)
				{
					...
					KeyedCollection = new Dictionary<long, UserPref>();

					FKKeyedCollection = new Dictionary<string, Dictionary<object, List<UserPref>>>();
	...
	#endregion UserPref Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for UserPref event args such as population
	/// </summary>
	[Serializable]
	public class UserPref_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private UserPrefCollection _coll = new UserPrefCollection();

		/// <summary>
		/// Creates a new UserPref_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public UserPref_GetCollection_EventArgs(int currentIndex, int totalCount, UserPrefCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty UserPref_GetCollection_EventArgs.
		/// </summary>
		public UserPref_GetCollection_EventArgs()
		{
		}
	...
	/// <summary>
	/// An object to populate a UserPrefCollection asynchronously.
	/// </summary>
	public class UserPrefCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private UserPrefCollection _coll = new UserPrefCollection();
		...
		/// <summary>
		/// Creates a new UserPref_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public UserPrefCollection_GetAsyncObject(int currentIndex, int totalCount, UserPrefCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
