...
namespace LEAD
{
		...
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		private SessionRibbon _originalValues = null;
		...
		/// <summary>
		/// Creates a new SessionRibbon.
		/// </summary>
		public SessionRibbon()
		{
		...
		/// <summary>
		/// Builds a SessionRibbonbased on a certain record from the database.
		/// </summary>
		/// <param name="ribbonGUID">A primary key used to select the record.</param>
		public SessionRibbon(string ribbonGUID)
		{
			if (ribbonGUID != null && 
				!String.IsNullOrEmpty(ribbonGUID))
			{
				this.Get(ribbonGUID);
			}
		...
		/// <summary>
		/// Property generated from the sRibbonGUID field.
		/// </summary>
		public string RibbonGUID
		{
			get 
			{
			...
			set 
			{
				if (_ribbonGUID != value)
				{
					bool cancelled = NotifyPropertyChanging("RibbonGUID", _ribbonGUID, value);
					if (!cancelled)
					{
						_ribbonGUID = value;
						SetModifiedStatus("RibbonGUID");
						NotifyPropertyChanged("RibbonGUID", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sNavTabKey field.
		/// </summary>
		public string NavTabKey
		{
			get 
			{
				if (RefreshRate != RefreshFrequency.ByDeveloperOnly) { RefreshObject(); }
			...
			set 
			{
				if (_navTabKey != value)
				{
					bool cancelled = NotifyPropertyChanging("NavTabKey", _navTabKey, value);
					if (!cancelled)
					{
						_navTabKey = value;
						SetModifiedStatus("NavTabKey");
						NotifyPropertyChanged("NavTabKey", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sActiveTab field.
		/// </summary>
		public string ActiveTab
		{
			...
			set 
			{
				if (_activeTab != value)
				{
					bool cancelled = NotifyPropertyChanging("ActiveTab", _activeTab, value);
					if (!cancelled)
					{
						_activeTab = value;
						SetModifiedStatus("ActiveTab");
						NotifyPropertyChanged("ActiveTab", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sActiveButton field.
		/// </summary>
		public string ActiveButton
		{
			...
			set 
			{
				...
				{
					bool cancelled = NotifyPropertyChanging("ActiveButton", _activeButton, value);
					if (!cancelled)
					{
						_activeButton = value;
						SetModifiedStatus("ActiveButton");
						NotifyPropertyChanged("ActiveButton", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// A SessionRibbon with all of this object's original values.
		/// </summary>
		[Newtonsoft.Json.JsonIgnore]
		public SessionRibbon OriginalValues
		{
		...
		public void SetBaseRules()
		{
			...
			this.Rules.Add(new PropertyRequiredCustomRule("RibbonGUID", "The \"Ribbon GUID\" field is required in the SessionRibbon record.", RecordStatus.Modified));
			this.Rules.Add(new PropertyRequiredCustomRule("SessionGUID", "The \"Session GUID\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("ObjectID", "The \"Object ID\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("SortOrder", "The \"Sort Order\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Inactive", "The \"Inactive\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateAdded", "The \"Date Added\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateUpdated", "The \"Date Updated\" field is required in the SessionRibbon record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Rowversion", "The \"Rowversion\" field is required in the SessionRibbon record.", RecordStatus.Modified));

			// Max Length Rules
			this.Rules.Add(new MaxLengthCustomRule("NavTabKey", 200, "The maximum length for the \"NavTabKey\" field is 200 characters."));
			this.Rules.Add(new MaxLengthCustomRule("PageKey", 200, "The maximum length for the \"PageKey\" field is 200 characters."));
			this.Rules.Add(new MaxLengthCustomRule("ActiveTab", 200, "The maximum length for the \"ActiveTab\" field is 200 characters."));
			this.Rules.Add(new MaxLengthCustomRule("ActiveButton", 200, "The maximum length for the \"ActiveButton\" field is 200 characters."));
		...
		public SessionRibbon Clone()
		{
			SessionRibbon item = base.CloneObjectWithIL<SessionRibbon>(this);
		...
		public object CopyWithNewID()
		{
			...
			SessionRibbon item = this.Clone();
			
			// Change the ID field
			item.RibbonGUID = System.Guid.NewGuid().ToString();
		...
		public ClassGenExceptionCollection RefreshObject(int threshHoldInMinutes)
		{
			...
			if (((TimeSpan)currentTime.Subtract(_dateTimeObjectPopulated.Value)).TotalMinutes > threshHoldInMinutes)
			{
				...
				errors.AddRange(this.Get(_ribbonGUID));
			}
		...
		public ClassGenExceptionCollection RefreshForce()
		{
			...
			if (!String.IsNullOrEmpty(this._ribbonGUID))
			{
				errors.AddRange(this.Get(_ribbonGUID));	// Just do a get on the object
			}
			else
			{
		...
		public override void UndoChanges()
		{
			...
			_ribbonGUID = _originalValues.RibbonGUID;
			_sessionGUID = _originalValues.SessionGUID;
			_navTabKey = _originalValues.NavTabKey;
			_pageKey = _originalValues.PageKey;
			_objectID = _originalValues.ObjectID;
			_activeTab = _originalValues.ActiveTab;
			_activeButton = _originalValues.ActiveButton;
		...
		public ClassGenExceptionCollection AddUpdate(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			if (String.IsNullOrEmpty(_ribbonGUID)) { _ribbonGUID = System.Guid.NewGuid().ToString(); }
			...
			if (_recordStatus == RecordStatus.Deleted)
			{
				try
				{
					...
					errors.AddRange(LEAD_BaseObject.DeleteImmediate("tSessionRibbon", "sRibbonGUID", _ribbonGUID, true));
				}
				catch (SqlException sqle) { errors.Add(new ClassGenException(sqle)); }
				catch (Exception ex) { errors.Add(new ClassGenException(ex)); }
			...
			if (_recordStatus == RecordStatus.New || _recordStatus == RecordStatus.Modified)
			{
				...
				{
					byte[] timeStampFromTable = DAL.GetTimeStampFromTable("tSessionRibbon", "bRowversion",
						"sRibbonGUID = '" + this.RibbonGUID + "'");
				...
				try
				{
					...
					sql = "IF NOT EXISTS (SELECT sRibbonGUID FROM tSessionRibbon WHERE sRibbonGUID = @psRibbonGUID) " + 
						"INSERT INTO tSessionRibbon (sRibbonGUID, sSessionGUID, sNavTabKey, sPageKey, iObjectID, sActiveTab, sActiveButton, iSortOrder, bInactive, sAddedByUser, dtUpdated, sUpdatedByUser) " + 
						"SELECT @psRibbonGUID, @psSessionGUID, @psNavTabKey, @psPageKey, @piObjectID, @psActiveTab, @psActiveButton, @piSortOrder, @pbInactive, @psAddedByUser, @pdtUpdated, @psUpdatedByUser " + 
						"ELSE " + 
						"UPDATE tSessionRibbon SET " + 
						"sRibbonGUID = @psRibbonGUID" + 
						",sSessionGUID = @psSessionGUID" + 
						",iObjectID = @piObjectID" + 
						",iSortOrder = @piSortOrder" + 
						",bInactive = @pbInactive" + 
						",dtUpdated = @pdtUpdated" + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("NavTabKey")) ? ",sNavTabKey = @psNavTabKey" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("PageKey")) ? ",sPageKey = @psPageKey" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("ActiveTab")) ? ",sActiveTab = @psActiveTab" : "") + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("ActiveButton")) ? ",sActiveButton = @psActiveButton" : "") + 
						...
						" WHERE sRibbonGUID = @psRibbonGUID;  SELECT @psRibbonGUID AS ret_val, bRowversion FROM tSessionRibbon WHERE sRibbonGUID = @psRibbonGUID";
					cmd = new SqlCommand(sql);

					cmd.Parameters.Add("@psRibbonGUID", SqlDbType.UniqueIdentifier).Value = new System.Guid(_ribbonGUID);
					cmd.Parameters.Add("@psSessionGUID", SqlDbType.UniqueIdentifier).Value = new System.Guid(_sessionGUID);
					cmd.Parameters.Add("@psNavTabKey", SqlDbType.VarChar, 200).Value = (_navTabKey == null ? (object)DBNull.Value : (object)_navTabKey);
					...
					cmd.Parameters.Add("@psActiveTab", SqlDbType.VarChar, 200).Value = (_activeTab == null ? (object)DBNull.Value : (object)_activeTab);
					cmd.Parameters.Add("@psActiveButton", SqlDbType.VarChar, 200).Value = (_activeButton == null ? (object)DBNull.Value : (object)_activeButton);
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						string oldRecID = _ribbonGUID;

						_ribbonGUID = row["ret_val"].ToString();
		...
		/// </summary>
		/// <param name="ribbonGUID">A key field used to find the correct record.</param>
		/// <param name="includeParentPopulation">Whether or not to include values derived from a parent table.</param>
		public ClassGenExceptionCollection Get(string ribbonGUID, bool includeParentPopulation)
		{
			ClassGenExceptionCollection errors = new ClassGenExceptionCollection();
			SqlCommand cmd = null;
			string sql = string.Empty;
			...
			try
			{
				sql = "SELECT [SR].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tSessionRibbon [SR] " + 
					"WHERE [SR].[sRibbonGUID] = @psRibbonGUID " + 
					"";
				cmd = new SqlCommand(sql);
				cmd.Parameters.Add("@psRibbonGUID", SqlDbType.UniqueIdentifier).Value = new System.Guid(ribbonGUID);
		...
		public ClassGenExceptionCollection Get(string ribbonGUID)
		{
			return Get(ribbonGUID, false);		// Get the item
		}
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_ribbonGUID = (row["sRibbonGUID"] != DBNull.Value ? row["sRibbonGUID"].ToString().ToLower() : string.Empty);
				_sessionGUID = (row["sSessionGUID"] != DBNull.Value ? row["sSessionGUID"].ToString().ToLower() : string.Empty);
				_navTabKey = (row["sNavTabKey"] != DBNull.Value ? _navTabKey = row["sNavTabKey"].ToString() : null);
				...
				_activeTab = (row["sActiveTab"] != DBNull.Value ? _activeTab = row["sActiveTab"].ToString() : null);
				_activeButton = (row["sActiveButton"] != DBNull.Value ? _activeButton = row["sActiveButton"].ToString() : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<SessionRibbon>(this, dt);
		}
		...
		// Main Class - SessionRibbon

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_RibbonGUID = "RibbonGUID";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_NavTabKey = "NavTabKey";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_ActiveTab = "ActiveTab";

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_ActiveButton = "ActiveButton";
		...
		public static string GetDBFieldName(SessionRibbonField field)
		{
			...
			switch (field)
			{
				case SessionRibbonField.RibbonGUID: fldName = "sRibbonGUID"; break;
				case SessionRibbonField.SessionGUID: fldName = "sSessionGUID"; break;
				case SessionRibbonField.NavTabKey: fldName = "sNavTabKey"; break;
				case SessionRibbonField.PageKey: fldName = "sPageKey"; break;
				case SessionRibbonField.ObjectID: fldName = "iObjectID"; break;
				case SessionRibbonField.ActiveTab: fldName = "sActiveTab"; break;
				case SessionRibbonField.ActiveButton: fldName = "sActiveButton"; break;
				case SessionRibbonField.SortOrder: fldName = "iSortOrder"; break;
				case SessionRibbonField.Inactive: fldName = "bInactive"; break;
				case SessionRibbonField.DateAdded: fldName = "dtAdded"; break;
				case SessionRibbonField.AddedByUser: fldName = "sAddedByUser"; break;
				case SessionRibbonField.DateUpdated: fldName = "dtUpdated"; break;
				case SessionRibbonField.UpdatedByUser: fldName = "sUpdatedByUser"; break;
				case SessionRibbonField.Rowversion: fldName = "bRowversion"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "sribbonguid") { fldName = SessionRibbonField.RibbonGUID.ToString(); }
			else if (field.ToLower() == "ssessionguid") { fldName = SessionRibbonField.SessionGUID.ToString(); }
			else if (field.ToLower() == "snavtabkey") { fldName = SessionRibbonField.NavTabKey.ToString(); }
			else if (field.ToLower() == "spagekey") { fldName = SessionRibbonField.PageKey.ToString(); }
			else if (field.ToLower() == "iobjectid") { fldName = SessionRibbonField.ObjectID.ToString(); }
			else if (field.ToLower() == "sactivetab") { fldName = SessionRibbonField.ActiveTab.ToString(); }
			else if (field.ToLower() == "sactivebutton") { fldName = SessionRibbonField.ActiveButton.ToString(); }
			else if (field.ToLower() == "isortorder") { fldName = SessionRibbonField.SortOrder.ToString(); }
			else if (field.ToLower() == "binactive") { fldName = SessionRibbonField.Inactive.ToString(); }
			else if (field.ToLower() == "dtadded") { fldName = SessionRibbonField.DateAdded.ToString(); }
			else if (field.ToLower() == "saddedbyuser") { fldName = SessionRibbonField.AddedByUser.ToString(); }
			else if (field.ToLower() == "dtupdated") { fldName = SessionRibbonField.DateUpdated.ToString(); }
			else if (field.ToLower() == "supdatedbyuser") { fldName = SessionRibbonField.UpdatedByUser.ToString(); }
			else if (field.ToLower() == "browversion") { fldName = SessionRibbonField.Rowversion.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "tSessionRibbon"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(SessionRibbonField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(SessionRibbonField field, string whereClause)
		{
		...
		public static DataTable GetDistinctFromDBAsDataTable(SessionRibbonField[] fields, 
			string[] fieldAliases,
			SessionRibbonField[] sortedFields, 
			string whereClause)
		{
			Dictionary<SessionRibbonField, string> fieldNames = new Dictionary<SessionRibbonField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (SessionRibbonField fld in fields)
			{
			...
			Dictionary<SessionRibbonField, string> sortedFieldNames = new Dictionary<SessionRibbonField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (SessionRibbonField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(SessionRibbonMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(SessionRibbonMinMaxDateField field, string whereClause)
		{
			SessionRibbonField fld = (SessionRibbonField)Enum.Parse(typeof(SessionRibbonField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(SessionRibbonMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(SessionRibbonMinMaxDateField field, string whereClause)
		{
			SessionRibbonField fld = (SessionRibbonField)Enum.Parse(typeof(SessionRibbonField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(SessionRibbonMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(SessionRibbonMinMaxNumberField field, string whereClause)
		{
			SessionRibbonField fld = (SessionRibbonField)Enum.Parse(typeof(SessionRibbonField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(SessionRibbonMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(SessionRibbonMinMaxNumberField field, string whereClause)
		{
			SessionRibbonField fld = (SessionRibbonField)Enum.Parse(typeof(SessionRibbonField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static SessionRibbon CopyFrom(SessionRibbon source)
		{
			// Make the copy of the object
			SessionRibbon item = source.Clone();
		...
		public static string ToDBFriendly(string dbString)
		{
			...
			rtv = rtv.Replace("[RibbonGUID]", "[sRibbonGUID]");
			rtv = rtv.Replace("[SessionGUID]", "[sSessionGUID]");
			rtv = rtv.Replace("[NavTabKey]", "[sNavTabKey]");
			rtv = rtv.Replace("[PageKey]", "[sPageKey]");
			rtv = rtv.Replace("[ObjectID]", "[iObjectID]");
			rtv = rtv.Replace("[ActiveTab]", "[sActiveTab]");
			rtv = rtv.Replace("[ActiveButton]", "[sActiveButton]");
		...
		/// <summary>
		/// Attempt to serialize the SessionRibbon object to the server
		/// </summary>
		/// <param name="obj">The SessionRibbon object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(SessionRibbon obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the SessionRibbon object from the server
		/// </summary>
		/// <param name="obj">The SessionRibbon object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A SessionRibbon object containing the return from the method</returns>
		public static SessionRibbon DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			SessionRibbon rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<SessionRibbon>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<RibbonGUID>" + System.Security.SecurityElement.Escape(RibbonGUID) + "</RibbonGUID>" + Environment.NewLine);
			sb.Append("<SessionGUID>" + System.Security.SecurityElement.Escape(SessionGUID) + "</SessionGUID>" + Environment.NewLine);
			sb.Append("<NavTabKey>" + System.Security.SecurityElement.Escape(NavTabKey) + "</NavTabKey>" + Environment.NewLine);
			...
			sb.Append("<ActiveTab>" + System.Security.SecurityElement.Escape(ActiveTab) + "</ActiveTab>" + Environment.NewLine);
			sb.Append("<ActiveButton>" + System.Security.SecurityElement.Escape(ActiveButton) + "</ActiveButton>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<SessionRibbon>" + Environment.NewLine);
				sb.Append("</SessionRibbon>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			if (_originalValues.RibbonGUID != RibbonGUID)
			{
				sb.Append("\t<RibbonGUID>");
				sb.Append("<OldValue>" + _originalValues.RibbonGUID + "</OldValue>");
				sb.Append("<NewValue>" + RibbonGUID + "</NewValue>");
				sb.Append("</RibbonGUID>" + Environment.NewLine);
			}
			...
			if (_originalValues.NavTabKey != NavTabKey)
			{
				sb.Append("\t<NavTabKey>");
				sb.Append("<OldValue>" + _originalValues.NavTabKey + "</OldValue>");
				sb.Append("<NewValue>" + NavTabKey + "</NewValue>");
				sb.Append("</NavTabKey>" + Environment.NewLine);
			}
			...
			if (_originalValues.ActiveTab != ActiveTab)
			{
				sb.Append("\t<ActiveTab>");
				sb.Append("<OldValue>" + _originalValues.ActiveTab + "</OldValue>");
				sb.Append("<NewValue>" + ActiveTab + "</NewValue>");
				sb.Append("</ActiveTab>" + Environment.NewLine);
			}
			if (_originalValues.ActiveButton != ActiveButton)
			{
				sb.Append("\t<ActiveButton>");
				sb.Append("<OldValue>" + _originalValues.ActiveButton + "</OldValue>");
				sb.Append("<NewValue>" + ActiveButton + "</NewValue>");
				sb.Append("</ActiveButton>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new SessionRibbon object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new SessionRibbon object.</returns>
		public static SessionRibbon LoadFromXML(string xml)
		{
			SessionRibbon item = new SessionRibbon();
			...
			foreach (System.Xml.XmlNode child in doc.ChildNodes[0].ChildNodes)
			{
				...
				switch (child.Name)
				{
					case "RibbonGUID": item.RibbonGUID = child.InnerText; break;
					case "SessionGUID": item.SessionGUID = child.InnerText; break;
					case "NavTabKey": item.NavTabKey = child.InnerText; break;
					case "PageKey": item.PageKey = child.InnerText; break;
					case "ObjectID": item.ObjectID = long.Parse(child.InnerText); break;

					case "ActiveTab": item.ActiveTab = child.InnerText; break;
					case "ActiveButton": item.ActiveButton = child.InnerText; break;
	...
	#endregion SessionRibbon Class

	#region SessionRibbonField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum SessionRibbonField
	{
		/// <summary>
		/// The RibbonGUID element.
		/// </summary>
		RibbonGUID,
		/// <summary>
		...
		ObjectID,
		/// <summary>
		/// The ActiveTab element.
		/// </summary>
		ActiveTab,
		/// <summary>
		/// The ActiveButton element.
		/// </summary>
		ActiveButton,
		/// <summary>
	...
	#endregion SessionRibbonField Enum

	#region SessionRibbonMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum SessionRibbonMinMaxDateField
	{
		/// <summary>
		/// The DateAdded element.
		/// </summary>
	...
	#endregion SessionRibbonMinMaxDateField Enum

	#region SessionRibbonMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum SessionRibbonMinMaxNumberField
	{
		/// <summary>
		/// The ObjectID element.
		/// </summary>
	...
	#endregion SessionRibbonMinMaxNumberField Enum

	#region SessionRibbon Collection
	/// <summary>
	/// A collection for SessionRibbon objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with SessionRibbon objects.
	/// Most of the functionality is in this class, including the methods for creating SessionRibbon objects from a database.
	/// </remarks>
	[Serializable]
	public partial class SessionRibbonCollection : ClassGenBindingList<SessionRibbon, string>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated, IClassGenClassUpdatable
	{
		...
		/// </summary>
		public SessionRibbonCollection() 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RibbonGUID";
		...
		public SessionRibbonCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RibbonGUID";
		...
		public SessionRibbonCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RibbonGUID";
		...
		/// </summary>
		/// <param name="ribbonGUID">A key field used to find the correct record.</param>
		/// <returns>The SessionRibbon object that matches the given value.</returns>
		public SessionRibbon Get(string ribbonGUID)
		{
			SessionRibbon val = null;
			if (KeyedCollection.ContainsKey(ribbonGUID.ToLower())) { val = KeyedCollection[ribbonGUID.ToLower()]; }
			return val;
		}
		...
		/// </summary>
		public new SessionRibbonCollection ActiveRecords
		{
			get
			{
				return (SessionRibbonCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public SessionRibbonCollection DeletedRecords
		{
			get
			{
				return (SessionRibbonCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public SessionRibbonCollection ModifiedRecords
		{
			get
			{
				return (SessionRibbonCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public SessionRibbonCollection NewRecords
		{
			get
			{
				return (SessionRibbonCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = SessionRibbonCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = SessionRibbonCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [SR].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tSessionRibbon [SR] " + 
				...
				this.OnMasterPopulate("SessionRibbon", "Retrieving Full List Of SessionRibbons", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("SessionRibbon", 
						"Populating SessionRibbon: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
					...
					if (this.Contains(item.RibbonGUID)) { this.Remove(item.RibbonGUID); }
		...
		public ClassGenExceptionCollection AddUpdateAll(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			try
			{
				...
				{
					this.OnDetailDelete("SessionRibbon",
						"Deleting SessionRibbon: " + (this.Count - i + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						this.Count - i + 1);
					SessionRibbon item = this[i];
				...
				// Update Method
				int count = 0;
				foreach (SessionRibbon item in this)
				{
					this.OnDetailUpdate("SessionRibbon",
						"Updating SessionRibbon: " + (count + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						count + 1);
		...
		public new SessionRibbonCollection Clone()
		{
			SessionRibbonCollection newColl = new SessionRibbonCollection();
		...
		/// </summary>
		/// <returns>A new SessionRibbonCollection.</returns>
		public new SessionRibbonCollection CopyWithNewIDs()
		{
			return (SessionRibbonCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.SessionRibbonField field)
		{
			...
			switch (field)
			{
				case LEAD.SessionRibbonField.RibbonGUID:
					foreach (SessionRibbon item in this)
					{
						if (!String.IsNullOrEmpty(item.RibbonGUID) && 
							!vals.ContainsKey(item.RibbonGUID.Trim())) { vals.Add(item.RibbonGUID.Trim(), item.RibbonGUID.Trim()); }
					}
					break;
				case LEAD.SessionRibbonField.SessionGUID:
					foreach (SessionRibbon item in this)
					{
					...
					break;
				case LEAD.SessionRibbonField.NavTabKey:
					foreach (SessionRibbon item in this)
					{
						if (!String.IsNullOrEmpty(item.NavTabKey) && 
							!vals.ContainsKey(item.NavTabKey.Trim())) { vals.Add(item.NavTabKey.Trim(), item.NavTabKey.Trim()); }
					}
					break;
				case LEAD.SessionRibbonField.PageKey:
					foreach (SessionRibbon item in this)
					{
					...
					break;
				case LEAD.SessionRibbonField.ObjectID:
					foreach (SessionRibbon item in this)
					{
					...
					break;
				case LEAD.SessionRibbonField.ActiveTab:
					foreach (SessionRibbon item in this)
					{
						if (!String.IsNullOrEmpty(item.ActiveTab) && 
							!vals.ContainsKey(item.ActiveTab.Trim())) { vals.Add(item.ActiveTab.Trim(), item.ActiveTab.Trim()); }
					}
					break;
				case LEAD.SessionRibbonField.ActiveButton:
					foreach (SessionRibbon item in this)
					{
						if (!String.IsNullOrEmpty(item.ActiveButton) && 
							!vals.ContainsKey(item.ActiveButton.Trim())) { vals.Add(item.ActiveButton.Trim(), item.ActiveButton.Trim()); }
					}
					break;
				case LEAD.SessionRibbonField.SortOrder:
					foreach (SessionRibbon item in this)
					{
					...
					break;
				case LEAD.SessionRibbonField.AddedByUser:
					foreach (SessionRibbon item in this)
					{
					...
					break;
				case LEAD.SessionRibbonField.UpdatedByUser:
					foreach (SessionRibbon item in this)
					{
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (SessionRibbon item in this.ActiveRecords)
				{
		...
		/// </summary>
		/// <returns>A SessionRibbonCollection of current records.</returns>
		public SessionRibbonCollection GetCurrent()
		{
		...
		public bool Exists(string ribbonGUID)
		{
			return (this.Exists(new Predicate<SessionRibbon>(delegate (SessionRibbon obj) 
				{ return obj.RibbonGUID.ToLower() == ribbonGUID.ToLower(); })));
		}
		...
		/// </summary>
		/// <param name="ribbonGUID">A key field used to find the correct record.</param>
		public void Remove(string ribbonGUID)
		{
			for (int i = this.Count - 1; i >= 0; i--)
			{
				if (this[i].RibbonGUID.ToLower() == ribbonGUID.ToLower())
				{
					this.RemoveAt(i);
				}
			}
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<SessionRibbon>();
		}
		...
		public static int Delete(string whereClause, ref ClassGenExceptionCollection errors)
		{
			...
			try
			{
				sql = "DELETE FROM tSessionRibbon " +
		...
		/// <summary>
		/// Attempt to serialize the SessionRibbonCollection object to the server
		/// </summary>
		/// <param name="obj">The SessionRibbonCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(SessionRibbonCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the SessionRibbonCollection object from the server
		/// </summary>
		/// <param name="obj">The SessionRibbonCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A SessionRibbonCollection object containing the return from the method</returns>
		public static SessionRibbonCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			SessionRibbonCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<SessionRibbonCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#SessionRibbon') IS NOT NULL  DROP TABLE #SessionRibbon; " + 
					"CREATE TABLE #SessionRibbon (sRibbonGUID uniqueidentifier, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #SessionRibbon (sRibbonGUID) SELECT sRibbonGUID FROM tSessionRibbon" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #SessionRibbon "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				SessionRibbonCollection_GetAsyncObject obj = (SessionRibbonCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.SessionRibbonCollection);
			}
		}
			...
			int pageSize)
		{
			...
			SessionRibbonCollection coll = new SessionRibbonCollection();
			SessionRibbon item = new SessionRibbon();
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [SR].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tSessionRibbon [SR] " + 
					"INNER JOIN #SessionRibbon TEMP ON [SR].[sRibbonGUID] = [TEMP].[sRibbonGUID] " +
				...
				// Populate the local SessionRibbon collection
				coll = new SessionRibbonCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new SessionRibbon();
					item.Get(row);
					coll.Add(item);
				}
				...
				// Report the progress
				SessionRibbonCollection_GetAsyncObject obj = new SessionRibbonCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, SessionRibbon_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, SessionRibbonCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (SessionRibbon a in coll)
				{
					this.Add(a);		// Add the SessionRibbon
				}

				SessionRibbon_GetCollection_EventArgs e = new SessionRibbon_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<SessionRibbonCollection>" + Environment.NewLine);
			sb.Append("</SessionRibbonCollection>" + Environment.NewLine);
			...
			foreach (SessionRibbon item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<SessionRibbon>" + Environment.NewLine);
						sbRead.Append("\t<RibbonGUID>" + item.RibbonGUID + "</RibbonGUID>" + Environment.NewLine);
						sbRead.Append("\t<SessionGUID>" + item.SessionGUID + "</SessionGUID>" + Environment.NewLine);
						sbRead.Append("\t<NavTabKey>" + (item.NavTabKey != null ? item.NavTabKey : "NULL") + "</NavTabKey>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<SessionRibbon>" + Environment.NewLine);
						sbDeleted.Append("\t<RibbonGUID>" + item.RibbonGUID + "</RibbonGUID>" + Environment.NewLine);
						sbDeleted.Append("\t<SessionGUID>" + item.SessionGUID + "</SessionGUID>" + Environment.NewLine);
						sbDeleted.Append("\t<NavTabKey>" + (item.NavTabKey != null ? item.NavTabKey : "NULL") + "</NavTabKey>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<SessionRibbon>" + Environment.NewLine);
						sbNew.Append("\t<RibbonGUID>" + item.RibbonGUID + "</RibbonGUID>" + Environment.NewLine);
						sbNew.Append("\t<SessionGUID>" + item.SessionGUID + "</SessionGUID>" + Environment.NewLine);
						sbNew.Append("\t<NavTabKey>" + (item.NavTabKey != null ? item.NavTabKey : "NULL") + "</NavTabKey>" + Environment.NewLine);
		...
		/// <returns>The completed SessionRibbonCollection object.</returns>
		public static SessionRibbonCollection LoadFromXML(string xml)
		{
			SessionRibbonCollection coll = new SessionRibbonCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			// <SessionRibbonCollection>
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				...
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					...
					SessionRibbon item = SessionRibbon.LoadFromXML(node.OuterXml);
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this._disposed)
			{
				...
				if (disposing)
				{
					...
					KeyedCollection = new Dictionary<string, SessionRibbon>();
	...
	#endregion SessionRibbon Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for SessionRibbon event args such as population
	/// </summary>
	[Serializable]
	public class SessionRibbon_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private SessionRibbonCollection _coll = new SessionRibbonCollection();

		/// <summary>
		/// Creates a new SessionRibbon_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public SessionRibbon_GetCollection_EventArgs(int currentIndex, int totalCount, SessionRibbonCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty SessionRibbon_GetCollection_EventArgs.
		/// </summary>
		public SessionRibbon_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public SessionRibbonCollection SessionRibbonCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a SessionRibbonCollection asynchronously.
	/// </summary>
	public class SessionRibbonCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private SessionRibbonCollection _coll = new SessionRibbonCollection();
		...
		/// <summary>
		/// Creates a new SessionRibbon_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public SessionRibbonCollection_GetAsyncObject(int currentIndex, int totalCount, SessionRibbonCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
