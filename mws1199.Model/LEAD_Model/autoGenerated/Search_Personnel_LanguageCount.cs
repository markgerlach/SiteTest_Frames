...
{
	/// <summary>
	/// Class Name: Search_Personnel_LanguageCount
	/// Generated by GenClasses v.4.0.0 on 07/28/2017 05:18 AM
	/// </summary>
	#region Search_Personnel_LanguageCount Class
	[Serializable]
	public partial class Search_Personnel_LanguageCount : LEAD_BaseObject, 
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		/// <summary>
		/// Creates a new Search_Personnel_LanguageCount.
		/// </summary>
		public Search_Personnel_LanguageCount()
		{
		...
		/// <summary>
		/// Property generated from the iCount field.
		/// </summary>
		public int? Count
		{
			get 
			...
			set 
			{
				if (_count != value)
				{
					bool cancelled = NotifyPropertyChanging("Count", _count, value);
					if (!cancelled)
					{
						_count = value;
						SetModifiedStatus("Count");
						NotifyPropertyChanged("Count", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// The value of Count rendered as a string.
		/// </summary>
		...
		public Search_Personnel_LanguageCount Clone()
		{
			Search_Personnel_LanguageCount item = base.CloneObjectWithIL<Search_Personnel_LanguageCount>(this);
		...
		public object CopyWithNewID()
		{
			...
			Search_Personnel_LanguageCount item = this.Clone();
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_count = (row["iCount"] != DBNull.Value ? _count = int.Parse(row["iCount"].ToString()) : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<Search_Personnel_LanguageCount>(this, dt);
		}
		...
		// Main Class - Search_Personnel_LanguageCount
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_Count = "Count";
		...
		public static string GetDBFieldName(Search_Personnel_LanguageCountField field)
		{
			...
			switch (field)
			{
				case Search_Personnel_LanguageCountField.RecGUID: fldName = "sRecGUID"; break;
				case Search_Personnel_LanguageCountField.Language: fldName = "sLanguage"; break;
				case Search_Personnel_LanguageCountField.Count: fldName = "iCount"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "srecguid") { fldName = Search_Personnel_LanguageCountField.RecGUID.ToString(); }
			else if (field.ToLower() == "slanguage") { fldName = Search_Personnel_LanguageCountField.Language.ToString(); }
			else if (field.ToLower() == "icount") { fldName = Search_Personnel_LanguageCountField.Count.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "vwSearch_Personnel_LanguageCount"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_LanguageCountField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(Search_Personnel_LanguageCountField field, string whereClause)
		{
			...
			try
			{
				sql = "SELECT DISTINCT LTRIM(RTRIM([" + fldName + "])) " +
						"FROM [vwSearch_Personnel_LanguageCount] " +
		...
		public static DataTable GetDistinctFromDBAsDataTable(Search_Personnel_LanguageCountField[] fields, 
			string[] fieldAliases,
			Search_Personnel_LanguageCountField[] sortedFields, 
			string whereClause)
		{
			Dictionary<Search_Personnel_LanguageCountField, string> fieldNames = new Dictionary<Search_Personnel_LanguageCountField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (Search_Personnel_LanguageCountField fld in fields)
			{
			...
			Dictionary<Search_Personnel_LanguageCountField, string> sortedFieldNames = new Dictionary<Search_Personnel_LanguageCountField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (Search_Personnel_LanguageCountField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(Search_Personnel_LanguageCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(Search_Personnel_LanguageCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_LanguageCountField fld = (Search_Personnel_LanguageCountField)Enum.Parse(typeof(Search_Personnel_LanguageCountField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(Search_Personnel_LanguageCountMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(Search_Personnel_LanguageCountMinMaxDateField field, string whereClause)
		{
			Search_Personnel_LanguageCountField fld = (Search_Personnel_LanguageCountField)Enum.Parse(typeof(Search_Personnel_LanguageCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(Search_Personnel_LanguageCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(Search_Personnel_LanguageCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_LanguageCountField fld = (Search_Personnel_LanguageCountField)Enum.Parse(typeof(Search_Personnel_LanguageCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(Search_Personnel_LanguageCountMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(Search_Personnel_LanguageCountMinMaxNumberField field, string whereClause)
		{
			Search_Personnel_LanguageCountField fld = (Search_Personnel_LanguageCountField)Enum.Parse(typeof(Search_Personnel_LanguageCountField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static Search_Personnel_LanguageCount CopyFrom(Search_Personnel_LanguageCount source)
		{
			// Make the copy of the object
			Search_Personnel_LanguageCount item = source.Clone();
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_LanguageCount object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_LanguageCount object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_LanguageCount obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_LanguageCount object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_LanguageCount object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_LanguageCount object containing the return from the method</returns>
		public static Search_Personnel_LanguageCount DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_LanguageCount rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_LanguageCount>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<Count>" + System.Security.SecurityElement.Escape(Count.ToString()) + "</Count>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<Search_Personnel_LanguageCount>" + Environment.NewLine);
				sb.Append("</Search_Personnel_LanguageCount>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			sb.Append("</Count>" + Environment.NewLine);
		...
		/// <summary>
		/// Generates a new Search_Personnel_LanguageCount object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new Search_Personnel_LanguageCount object.</returns>
		public static Search_Personnel_LanguageCount LoadFromXML(string xml)
		{
			Search_Personnel_LanguageCount item = new Search_Personnel_LanguageCount();
			...
			foreach (System.Xml.XmlNode child in doc.ChildNodes[0].ChildNodes)
			{
				...
				switch (child.Name)
				{
					...
					case "Count": item.Count = (!String.IsNullOrEmpty(child.InnerText) ? int.Parse(child.InnerText) : (int?)null); break;
	...
	#endregion Search_Personnel_LanguageCount Class

	#region Search_Personnel_LanguageCountField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum Search_Personnel_LanguageCountField
	{
		/// <summary>
		/// The RecGUID element.
		/// </summary>
	...
	#endregion Search_Personnel_LanguageCountField Enum

	#region Search_Personnel_LanguageCountMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_LanguageCountMinMaxDateField
	{
	}
	#endregion Search_Personnel_LanguageCountMinMaxDateField Enum

	#region Search_Personnel_LanguageCountMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum Search_Personnel_LanguageCountMinMaxNumberField
	{
		/// <summary>
		/// The Count element.
		/// </summary>
	...
	#endregion Search_Personnel_LanguageCountMinMaxNumberField Enum

	#region Search_Personnel_LanguageCount Collection
	/// <summary>
	/// A collection for Search_Personnel_LanguageCount objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with Search_Personnel_LanguageCount objects.
	/// Most of the functionality is in this class, including the methods for creating Search_Personnel_LanguageCount objects from a database.
	/// </remarks>
	[Serializable]
	public partial class Search_Personnel_LanguageCountCollection : ClassGenBindingList<Search_Personnel_LanguageCount, string>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated
	{
		...
		/// </summary>
		public Search_Personnel_LanguageCountCollection() 
		{
		...
		public Search_Personnel_LanguageCountCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		public Search_Personnel_LanguageCountCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "RecGUID";
		...
		/// <returns>The Search_Personnel_LanguageCount that matches the given value for the recGUID property.</returns>
		public Search_Personnel_LanguageCount Get(string recGUID)
		{
			Search_Personnel_LanguageCount val = null;
		...
		/// </summary>
		public new Search_Personnel_LanguageCountCollection ActiveRecords
		{
			get
			{
				return (Search_Personnel_LanguageCountCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public Search_Personnel_LanguageCountCollection DeletedRecords
		{
			get
			{
				return (Search_Personnel_LanguageCountCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public Search_Personnel_LanguageCountCollection ModifiedRecords
		{
			get
			{
				return (Search_Personnel_LanguageCountCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public Search_Personnel_LanguageCountCollection NewRecords
		{
			get
			{
				return (Search_Personnel_LanguageCountCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = Search_Personnel_LanguageCountCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = Search_Personnel_LanguageCountCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [SPLC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_LanguageCount [SPLC] " + 
				...
				this.OnMasterPopulate("Search_Personnel_LanguageCount", "Retrieving Full List Of Search_Personnel_LanguageCounts", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("Search_Personnel_LanguageCount", 
						"Populating Search_Personnel_LanguageCount: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
		...
		public new Search_Personnel_LanguageCountCollection Clone()
		{
			Search_Personnel_LanguageCountCollection newColl = new Search_Personnel_LanguageCountCollection();
		...
		/// </summary>
		/// <returns>A new Search_Personnel_LanguageCountCollection.</returns>
		public new Search_Personnel_LanguageCountCollection CopyWithNewIDs()
		{
			return (Search_Personnel_LanguageCountCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.Search_Personnel_LanguageCountField field)
		{
			...
			switch (field)
			{
				case LEAD.Search_Personnel_LanguageCountField.RecGUID:
					foreach (Search_Personnel_LanguageCount item in this)
					{
						if (!String.IsNullOrEmpty(item.RecGUID) && 
							!vals.ContainsKey(item.RecGUID.Trim())) { vals.Add(item.RecGUID.Trim(), item.RecGUID.Trim()); }
					}
					break;
				case LEAD.Search_Personnel_LanguageCountField.Language:
					foreach (Search_Personnel_LanguageCount item in this)
					{
					...
					break;
				case LEAD.Search_Personnel_LanguageCountField.Count:
					foreach (Search_Personnel_LanguageCount item in this)
					{
						if (item.Count != null &&
							!String.IsNullOrEmpty(item.Count.ToString()) && 
							!vals.ContainsKey(item.Count.ToString().Trim())) { vals.Add(item.Count.ToString().Trim(), item.Count.ToString().Trim()); }
					}
					break;
			}
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (Search_Personnel_LanguageCount item in this.ActiveRecords)
				{
		...
		/// </summary>
		/// <returns>A Search_Personnel_LanguageCountCollection of current records.</returns>
		public Search_Personnel_LanguageCountCollection GetCurrent()
		{
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<Search_Personnel_LanguageCount>();
		}
		...
		public static int Delete(string whereClause, ref ClassGenExceptionCollection errors)
		{
			...
			try
			{
				sql = "DELETE FROM vwSearch_Personnel_LanguageCount " +
		...
		/// <summary>
		/// Attempt to serialize the Search_Personnel_LanguageCountCollection object to the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_LanguageCountCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(Search_Personnel_LanguageCountCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the Search_Personnel_LanguageCountCollection object from the server
		/// </summary>
		/// <param name="obj">The Search_Personnel_LanguageCountCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A Search_Personnel_LanguageCountCollection object containing the return from the method</returns>
		public static Search_Personnel_LanguageCountCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			Search_Personnel_LanguageCountCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<Search_Personnel_LanguageCountCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#Search_Personnel_LanguageCount') IS NOT NULL  DROP TABLE #Search_Personnel_LanguageCount; " + 
					"CREATE TABLE #Search_Personnel_LanguageCount (sRecGUID uniqueidentifier, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #Search_Personnel_LanguageCount (sRecGUID) SELECT sRecGUID FROM vwSearch_Personnel_LanguageCount" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #Search_Personnel_LanguageCount "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				Search_Personnel_LanguageCountCollection_GetAsyncObject obj = (Search_Personnel_LanguageCountCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.Search_Personnel_LanguageCountCollection);
			}
		}
			...
			int pageSize)
		{
			...
			Search_Personnel_LanguageCountCollection coll = new Search_Personnel_LanguageCountCollection();
			Search_Personnel_LanguageCount item = new Search_Personnel_LanguageCount();
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [SPLC].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM vwSearch_Personnel_LanguageCount [SPLC] " + 
					"INNER JOIN #Search_Personnel_LanguageCount TEMP ON [SPLC].[sRecGUID] = [TEMP].[sRecGUID] " +
				...
				// Populate the local Search_Personnel_LanguageCount collection
				coll = new Search_Personnel_LanguageCountCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new Search_Personnel_LanguageCount();
					item.Get(row);
					coll.Add(item);
				}
				...
				// Report the progress
				Search_Personnel_LanguageCountCollection_GetAsyncObject obj = new Search_Personnel_LanguageCountCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, Search_Personnel_LanguageCount_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, Search_Personnel_LanguageCountCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (Search_Personnel_LanguageCount a in coll)
				{
					this.Add(a);		// Add the Search_Personnel_LanguageCount
				}

				Search_Personnel_LanguageCount_GetCollection_EventArgs e = new Search_Personnel_LanguageCount_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<Search_Personnel_LanguageCountCollection>" + Environment.NewLine);
			sb.Append("</Search_Personnel_LanguageCountCollection>" + Environment.NewLine);
			...
			foreach (Search_Personnel_LanguageCount item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<Search_Personnel_LanguageCount>" + Environment.NewLine);
						...
						sbRead.Append("\t<Count>" + (item.Count != null ? item.Count.ToString() : "NULL") + "</Count>" + Environment.NewLine);
						sbRead.Append("</Search_Personnel_LanguageCount>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<Search_Personnel_LanguageCount>" + Environment.NewLine);
						...
						sbDeleted.Append("\t<Count>" + (item.Count != null ? item.Count.ToString() : "NULL") + "</Count>" + Environment.NewLine);
						sbDeleted.Append("</Search_Personnel_LanguageCount>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<Search_Personnel_LanguageCount>" + Environment.NewLine);
						...
						sbNew.Append("\t<Count>" + (item.Count != null ? item.Count.ToString() : "NULL") + "</Count>" + Environment.NewLine);
						sbNew.Append("</Search_Personnel_LanguageCount>" + Environment.NewLine);
		...
		/// <returns>The completed Search_Personnel_LanguageCountCollection object.</returns>
		public static Search_Personnel_LanguageCountCollection LoadFromXML(string xml)
		{
			Search_Personnel_LanguageCountCollection coll = new Search_Personnel_LanguageCountCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			// <Search_Personnel_LanguageCountCollection>
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				// <Search_Personnel_LanguageCount>
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					// These are the elements <DetailGUID>, <UserName>, etc.
					Search_Personnel_LanguageCount item = Search_Personnel_LanguageCount.LoadFromXML(node.OuterXml);
		...
		/// <summary>
		/// The number of records that have a Count value.
		/// </summary>
		public decimal CountOfCount
		{
			get { return this.Count; }
		}
		
		/// <summary>
		/// This collection's average Count.
		/// </summary>
		public decimal AvgOfCount
		{
			get
			{
				return LEAD_BaseObject.Math(this.GetAsList(), "Count", LEAD_BaseObject.MathFunctionType.Average);
			}
		}
		
		/// <summary>
		/// The total of each record's Count.
		/// </summary>
		public decimal SumOfCount
		{
			get
			{
				return LEAD_BaseObject.Math(this.GetAsList(), "Count", LEAD_BaseObject.MathFunctionType.Sum);
			}
		}
		
		/// <summary>
		/// The lowest Count present in the collection.
		/// </summary>
		public decimal MinOfCount
		{
			get
			{
				return LEAD_BaseObject.Math(this.GetAsList(), "Count", LEAD_BaseObject.MathFunctionType.Min);
			}
		}
		
		/// <summary>
		/// The greatest Count present in the collection.
		/// </summary>
		public decimal MaxOfCount
		{
			get
			{
				return LEAD_BaseObject.Math(this.GetAsList(), "Count", LEAD_BaseObject.MathFunctionType.Max);
			}
		}
	...
	#endregion Search_Personnel_LanguageCount Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for Search_Personnel_LanguageCount event args such as population
	/// </summary>
	[Serializable]
	public class Search_Personnel_LanguageCount_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private Search_Personnel_LanguageCountCollection _coll = new Search_Personnel_LanguageCountCollection();

		/// <summary>
		/// Creates a new Search_Personnel_LanguageCount_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public Search_Personnel_LanguageCount_GetCollection_EventArgs(int currentIndex, int totalCount, Search_Personnel_LanguageCountCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty Search_Personnel_LanguageCount_GetCollection_EventArgs.
		/// </summary>
		public Search_Personnel_LanguageCount_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public Search_Personnel_LanguageCountCollection Search_Personnel_LanguageCountCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a Search_Personnel_LanguageCountCollection asynchronously.
	/// </summary>
	public class Search_Personnel_LanguageCountCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private Search_Personnel_LanguageCountCollection _coll = new Search_Personnel_LanguageCountCollection();
		...
		/// <summary>
		/// Creates a new Search_Personnel_LanguageCount_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public Search_Personnel_LanguageCountCollection_GetAsyncObject(int currentIndex, int totalCount, Search_Personnel_LanguageCountCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
