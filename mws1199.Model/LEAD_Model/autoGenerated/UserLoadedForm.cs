...
namespace LEAD
{
		...
		IClassGenLogXML, IClassGenCopyWithNewID, IClassGenPropertyChanging, INotifyPropertyChanging
	{
		...
		private UserLoadedForm _originalValues = null;
		...
		/// <summary>
		/// Creates a new UserLoadedForm.
		/// </summary>
		public UserLoadedForm()
		{
		...
		/// <summary>
		/// Builds a UserLoadedFormbased on a certain record from the database.
		/// </summary>
		/// <param name="loadedID">A primary key used to select the record.</param>
		public UserLoadedForm(long loadedID)
		{
			this.Get(loadedID);
		...
		/// <summary>
		/// Property generated from the iLoadedID field.
		/// </summary>
		public long LoadedID
		{
			...
			set 
			{
				if (_loadedID != value)
				{
					bool cancelled = NotifyPropertyChanging("LoadedID", _loadedID, value);
					if (!cancelled)
					{
						_loadedID = value;
						SetModifiedStatus("LoadedID");
						NotifyPropertyChanged("LoadedID", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// Property generated from the sFormName field.
		/// </summary>
		public string FormName
		{
			...
			set 
			{
				if (_formName != value)
				{
					bool cancelled = NotifyPropertyChanging("FormName", _formName, value);
					if (!cancelled)
					{
						_formName = value;
						SetModifiedStatus("FormName");
						NotifyPropertyChanged("FormName", value);
					}
				}
			}
		}
		...
		/// <summary>
		/// A UserLoadedForm with all of this object's original values.
		/// </summary>
		[Newtonsoft.Json.JsonIgnore]
		public UserLoadedForm OriginalValues
		{
		...
		public void SetBaseRules()
		{
			...
			this.Rules.Add(new PropertyRequiredCustomRule("LoadedID", "The \"Loaded ID\" field is required in the UserLoadedForm record.", RecordStatus.Modified));
			this.Rules.Add(new PropertyRequiredCustomRule("AgencyID", "The \"Agency ID\" field is required in the UserLoadedForm record."));
			this.Rules.Add(new PropertyRequiredCustomRule("UserID", "The \"User ID\" field is required in the UserLoadedForm record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Inactive", "The \"Inactive\" field is required in the UserLoadedForm record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateAdded", "The \"Date Added\" field is required in the UserLoadedForm record."));
			this.Rules.Add(new PropertyRequiredCustomRule("DateUpdated", "The \"Date Updated\" field is required in the UserLoadedForm record."));
			this.Rules.Add(new PropertyRequiredCustomRule("Rowversion", "The \"Rowversion\" field is required in the UserLoadedForm record.", RecordStatus.Modified));

			// Max Length Rules
			this.Rules.Add(new MaxLengthCustomRule("FormName", 50, "The maximum length for the \"FormName\" field is 50 characters."));
		...
		public UserLoadedForm Clone()
		{
			UserLoadedForm item = base.CloneObjectWithIL<UserLoadedForm>(this);
		...
		public object CopyWithNewID()
		{
			...
			UserLoadedForm item = this.Clone();
		...
		public ClassGenExceptionCollection RefreshObject(int threshHoldInMinutes)
		{
			...
			if (((TimeSpan)currentTime.Subtract(_dateTimeObjectPopulated.Value)).TotalMinutes > threshHoldInMinutes)
			{
				...
				errors.AddRange(this.Get(_loadedID));
			}
		...
		public ClassGenExceptionCollection RefreshForce()
		{
			...
			if (!String.IsNullOrEmpty(this._loadedID.ToString()))
			{
				errors.AddRange(this.Get(_loadedID));	// Just do a get on the object
			}
			else
			{
		...
		public override void UndoChanges()
		{
			...
			_loadedID = _originalValues.LoadedID;
			_agencyID = _originalValues.AgencyID;
			_userID = _originalValues.UserID;
			_formName = _originalValues.FormName;
		...
		public ClassGenExceptionCollection AddUpdate(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			if (_recordStatus == RecordStatus.Deleted)
			{
				try
				{
					...
					errors.AddRange(LEAD_BaseObject.DeleteImmediate("tUserLoadedForm", "iLoadedID", _loadedID.ToString(), true));
				}
				catch (SqlException sqle) { errors.Add(new ClassGenException(sqle)); }
				catch (Exception ex) { errors.Add(new ClassGenException(ex)); }
			...
			if (_recordStatus == RecordStatus.New || _recordStatus == RecordStatus.Modified)
			{
				...
				{
					byte[] timeStampFromTable = DAL.GetTimeStampFromTable("tUserLoadedForm", "bRowversion",
						"iLoadedID = " + this.LoadedID + "");
				...
				try
				{
					...
					sql = "DECLARE @return_val BIGINT " + 
						"IF NOT EXISTS (SELECT iLoadedID FROM tUserLoadedForm WHERE iLoadedID = @piLoadedID) " + 
						"BEGIN" + 
						"    INSERT INTO tUserLoadedForm (iAgencyID, iUserID, sFormName, bInactive, sAddedByUser, dtUpdated, sUpdatedByUser) " + 
						"    SELECT @piAgencyID, @piUserID, @psFormName, @pbInactive, @psAddedByUser, @pdtUpdated, @psUpdatedByUser " + 
						"    SELECT @return_val = SCOPE_IDENTITY() " + 
						"END " + 
						"ELSE " + 
						"BEGIN " + 
						"    UPDATE tUserLoadedForm SET " + 
						"        iAgencyID = @piAgencyID" + 
						"        ,iUserID = @piUserID" + 
						"        ,bInactive = @pbInactive" + 
						"        ,dtUpdated = @pdtUpdated" + 
						(_recordStatus == RecordStatus.New || (_recordStatus == RecordStatus.Modified && _changedProps.Contains("FormName")) ? "        ,sFormName = @psFormName" : "") + 
						...
						"     WHERE iLoadedID = @piLoadedID " + 
						"     SELECT @return_val = @piLoadedID " + 
						"END; SELECT @return_val AS ret_val, bRowversion FROM tUserLoadedForm WHERE iLoadedID = @return_val";
					cmd = new SqlCommand(sql);

					cmd.Parameters.Add("@piLoadedID", SqlDbType.BigInt).Value = _loadedID;
					cmd.Parameters.Add("@piAgencyID", SqlDbType.BigInt).Value = _agencyID;
					cmd.Parameters.Add("@piUserID", SqlDbType.BigInt).Value = _userID;
					cmd.Parameters.Add("@psFormName", SqlDbType.VarChar, 50).Value = (_formName == null ? (object)DBNull.Value : (object)_formName);
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						long oldRecID = _loadedID;

						_loadedID = (long)row["ret_val"];
		...
		/// </summary>
		/// <param name="loadedID">A key field used to find the correct record.</param>
		/// <param name="includeParentPopulation">Whether or not to include values derived from a parent table.</param>
		public ClassGenExceptionCollection Get(long loadedID, bool includeParentPopulation)
		{
			ClassGenExceptionCollection errors = new ClassGenExceptionCollection();
			SqlCommand cmd = null;
			string sql = string.Empty;
			...
			try
			{
				sql = "SELECT [ULF].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserLoadedForm [ULF] " + 
					"WHERE [ULF].[iLoadedID] = @piLoadedID " + 
					"";
				cmd = new SqlCommand(sql);
				cmd.Parameters.Add("@piLoadedID", SqlDbType.BigInt).Value = loadedID;
		...
		public ClassGenExceptionCollection Get(long loadedID)
		{
			return Get(loadedID, false);		// Get the item
		}
		...
		public ClassGenExceptionCollection Get(DataRow row, bool includeParentPopulation)
		{
			...
			try
			{
				...
				_loadedID = long.Parse(row["iLoadedID"] != DBNull.Value ? row["iLoadedID"].ToString() : "0");
				...
				_formName = (row["sFormName"] != DBNull.Value ? _formName = row["sFormName"].ToString() : null);
		...
		public DataRow ToDataRow(DataTable dt)
		{
			...
			return ToDataRowWithIL<UserLoadedForm>(this, dt);
		}
		...
		// Main Class - UserLoadedForm

		/// <summary>
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_LoadedID = "LoadedID";
		...
		/// The property's name as a static value.
		/// </summary>
		public static readonly string FN_FormName = "FormName";
		...
		public static string GetDBFieldName(UserLoadedFormField field)
		{
			...
			switch (field)
			{
				case UserLoadedFormField.LoadedID: fldName = "iLoadedID"; break;
				case UserLoadedFormField.AgencyID: fldName = "iAgencyID"; break;
				case UserLoadedFormField.UserID: fldName = "iUserID"; break;
				case UserLoadedFormField.FormName: fldName = "sFormName"; break;
				case UserLoadedFormField.Inactive: fldName = "bInactive"; break;
				case UserLoadedFormField.DateAdded: fldName = "dtAdded"; break;
				case UserLoadedFormField.AddedByUser: fldName = "sAddedByUser"; break;
				case UserLoadedFormField.DateUpdated: fldName = "dtUpdated"; break;
				case UserLoadedFormField.UpdatedByUser: fldName = "sUpdatedByUser"; break;
				case UserLoadedFormField.Rowversion: fldName = "bRowversion"; break;
			}
		...
		public static string GetDBFieldName(string field)
		{
			...
			// Add the elements
			if (field.ToLower() == "iloadedid") { fldName = UserLoadedFormField.LoadedID.ToString(); }
			else if (field.ToLower() == "iagencyid") { fldName = UserLoadedFormField.AgencyID.ToString(); }
			else if (field.ToLower() == "iuserid") { fldName = UserLoadedFormField.UserID.ToString(); }
			else if (field.ToLower() == "sformname") { fldName = UserLoadedFormField.FormName.ToString(); }
			else if (field.ToLower() == "binactive") { fldName = UserLoadedFormField.Inactive.ToString(); }
			else if (field.ToLower() == "dtadded") { fldName = UserLoadedFormField.DateAdded.ToString(); }
			else if (field.ToLower() == "saddedbyuser") { fldName = UserLoadedFormField.AddedByUser.ToString(); }
			else if (field.ToLower() == "dtupdated") { fldName = UserLoadedFormField.DateUpdated.ToString(); }
			else if (field.ToLower() == "supdatedbyuser") { fldName = UserLoadedFormField.UpdatedByUser.ToString(); }
			else if (field.ToLower() == "browversion") { fldName = UserLoadedFormField.Rowversion.ToString(); }
		...
		/// </summary>
		public static readonly string DB_TableName = "tUserLoadedForm"; 
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(UserLoadedFormField field)
		{
		...
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public static List<string> GetDistinctFromDB(UserLoadedFormField field, string whereClause)
		{
		...
		public static DataTable GetDistinctFromDBAsDataTable(UserLoadedFormField[] fields, 
			string[] fieldAliases,
			UserLoadedFormField[] sortedFields, 
			string whereClause)
		{
			Dictionary<UserLoadedFormField, string> fieldNames = new Dictionary<UserLoadedFormField, string>();
			StringBuilder sbFields = new StringBuilder();
			StringBuilder sbWhereClause = new StringBuilder();
			int fieldCount = 0;
			foreach (UserLoadedFormField fld in fields)
			{
			...
			Dictionary<UserLoadedFormField, string> sortedFieldNames = new Dictionary<UserLoadedFormField, string>();
			StringBuilder sbSortedFields = new StringBuilder();
			foreach (UserLoadedFormField fld in sortedFields)
			{
		...
		public static DateTime? GetMinDateFromDB(UserLoadedFormMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single earliest DateTime from the collection.</returns>
		public static DateTime? GetMinDateFromDB(UserLoadedFormMinMaxDateField field, string whereClause)
		{
			UserLoadedFormField fld = (UserLoadedFormField)Enum.Parse(typeof(UserLoadedFormField),
				field.ToString(), true);
		...
		public static DateTime? GetMaxDateFromDB(UserLoadedFormMinMaxDateField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single latest DateTime from the collection.</returns>
		public static DateTime? GetMaxDateFromDB(UserLoadedFormMinMaxDateField field, string whereClause)
		{
			UserLoadedFormField fld = (UserLoadedFormField)Enum.Parse(typeof(UserLoadedFormField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMinNumberFromDB(UserLoadedFormMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single least value from the collection.</returns>
		public static decimal? GetMinNumberFromDB(UserLoadedFormMinMaxNumberField field, string whereClause)
		{
			UserLoadedFormField fld = (UserLoadedFormField)Enum.Parse(typeof(UserLoadedFormField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		public static decimal? GetMaxNumberFromDB(UserLoadedFormMinMaxNumberField field)
		{
		...
		/// <param name="whereClause">The where clause to fire against the database.</param>
		/// <returns>The single greatest value from the collection.</returns>
		public static decimal? GetMaxNumberFromDB(UserLoadedFormMinMaxNumberField field, string whereClause)
		{
			UserLoadedFormField fld = (UserLoadedFormField)Enum.Parse(typeof(UserLoadedFormField),
				field.ToString(), true);
			string fldName = GetDBFieldName(fld);
		...
		/// <returns>A copy of the object, with a new ID.</returns>
		public static UserLoadedForm CopyFrom(UserLoadedForm source)
		{
			// Make the copy of the object
			UserLoadedForm item = source.Clone();
		...
		public static string ToDBFriendly(string dbString)
		{
			...
			rtv = rtv.Replace("[LoadedID]", "[iLoadedID]");
			rtv = rtv.Replace("[AgencyID]", "[iAgencyID]");
			rtv = rtv.Replace("[UserID]", "[iUserID]");
			rtv = rtv.Replace("[FormName]", "[sFormName]");
		...
		/// <summary>
		/// Attempt to serialize the UserLoadedForm object to the server
		/// </summary>
		/// <param name="obj">The UserLoadedForm object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(UserLoadedForm obj)
		{
		...
		/// <summary>
		/// Attempt to Deserialize the UserLoadedForm object from the server
		/// </summary>
		/// <param name="obj">The UserLoadedForm object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A UserLoadedForm object containing the return from the method</returns>
		public static UserLoadedForm DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			UserLoadedForm rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<UserLoadedForm>(obj);
			}
			catch (Exception ex)
			{
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Append("<LoadedID>" + System.Security.SecurityElement.Escape(LoadedID.ToString()) + "</LoadedID>" + Environment.NewLine);
			...
			sb.Append("<FormName>" + System.Security.SecurityElement.Escape(FormName) + "</FormName>" + Environment.NewLine);
			...
			{
				sb.Insert(0, "<UserLoadedForm>" + Environment.NewLine);
				sb.Append("</UserLoadedForm>" + Environment.NewLine);
			}
		...
		public string GetChangedElementsAsXML()
		{
			...
			if (_originalValues.LoadedID != LoadedID)
			{
				sb.Append("\t<LoadedID>");
				sb.Append("<OldValue>" + _originalValues.LoadedID.ToString() + "</OldValue>");
				sb.Append("<NewValue>" + LoadedID.ToString() + "</NewValue>");
				sb.Append("</LoadedID>" + Environment.NewLine);
			}
			...
			if (_originalValues.FormName != FormName)
			{
				sb.Append("\t<FormName>");
				sb.Append("<OldValue>" + _originalValues.FormName + "</OldValue>");
				sb.Append("<NewValue>" + FormName + "</NewValue>");
				sb.Append("</FormName>" + Environment.NewLine);
			}
		...
		/// <summary>
		/// Generates a new UserLoadedForm object from an XML description.
		/// </summary>
		/// <param name="xml">The string of XML to load from.</param>
		/// <returns>A new UserLoadedForm object.</returns>
		public static UserLoadedForm LoadFromXML(string xml)
		{
			UserLoadedForm item = new UserLoadedForm();
	...
	#endregion UserLoadedForm Class

	#region UserLoadedFormField Enum
	/// <summary>
	/// Enum for each field type in the element.
	/// </summary>
	public enum UserLoadedFormField
	{
		/// <summary>
		/// The LoadedID element.
		/// </summary>
		LoadedID,
		/// <summary>
	...
	#endregion UserLoadedFormField Enum

	#region UserLoadedFormMinMaxDateField Enum
	/// <summary>
	/// Enum for each DateTime field in the element that can have a minimum or maximum.
	/// </summary>
	public enum UserLoadedFormMinMaxDateField
	{
		/// <summary>
		/// The DateAdded element.
		/// </summary>
	...
	#endregion UserLoadedFormMinMaxDateField Enum

	#region UserLoadedFormMinMaxNumberField Enum
	/// <summary>
	/// Enum for each numerical field in the element that can have a minimum or maximum.
	/// </summary>
	public enum UserLoadedFormMinMaxNumberField
	{
		/// <summary>
		/// The LoadedID element.
		/// </summary>
	...
	#endregion UserLoadedFormMinMaxNumberField Enum

	#region UserLoadedForm Collection
	/// <summary>
	/// A collection for UserLoadedForm objects.
	/// </summary>
	/// <remarks>
	/// This collection class is the primary way to work with UserLoadedForm objects.
	/// Most of the functionality is in this class, including the methods for creating UserLoadedForm objects from a database.
	/// </remarks>
	[Serializable]
	public partial class UserLoadedFormCollection : ClassGenBindingList<UserLoadedForm, long>, IDisposable, 
		IClassGenLogXMLCollection, IClassGenClassGenerated, IClassGenClassUpdatable
	{
		...
		/// </summary>
		public UserLoadedFormCollection() 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LoadedID";
		...
		public UserLoadedFormCollection(string whereClause) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LoadedID";
		...
		public UserLoadedFormCollection(string whereClause, bool getChildren) 
		{
			// The Key Field Name for the collection
			this.KeyFieldName = "LoadedID";
		...
		/// </summary>
		/// <param name="loadedID">A key field used to find the correct record.</param>
		/// <returns>The UserLoadedForm object that matches the given value.</returns>
		public UserLoadedForm Get(long loadedID)
		{
			UserLoadedForm val = null;
			if (KeyedCollection.ContainsKey(loadedID)) { val = KeyedCollection[loadedID]; }
			return val;
		}
		...
		/// <returns>A UserLoadedFormCollection of matching records.</returns>
		public UserLoadedFormCollection GetByUserID(long userID)
		{
			UserLoadedFormCollection coll = new UserLoadedFormCollection();
			if (FKKeyedCollection.ContainsKey("UserID"))
			{
				List<UserLoadedForm> list = new List<UserLoadedForm>();
				if (FKKeyedCollection["UserID"].ContainsKey(userID))
				{
					list = FKKeyedCollection["UserID"][userID];
				}
				foreach (UserLoadedForm item in list)
				{
					coll.Add(item);
				}
			}
		...
		/// </summary>
		public new UserLoadedFormCollection ActiveRecords
		{
			get
			{
				return (UserLoadedFormCollection)base.ActiveRecords;
			}
		}
		...
		/// </summary>
		public UserLoadedFormCollection DeletedRecords
		{
			get
			{
				return (UserLoadedFormCollection)GetRecordsBasedOnStatus(RecordStatus.Deleted);
			}
		}
		...
		/// </summary>
		public UserLoadedFormCollection ModifiedRecords
		{
			get
			{
				return (UserLoadedFormCollection)GetRecordsBasedOnStatus(RecordStatus.Modified);
			}
		}
		...
		/// </summary>
		public UserLoadedFormCollection NewRecords
		{
			get
			{
				return (UserLoadedFormCollection)GetRecordsBasedOnStatus(RecordStatus.New);
			}
		}
		...
		{
			dbCount = UserLoadedFormCollection.GetCountFromDB();
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB(string whereClause, ref long dbCount)
		{
			...
			dbCount = UserLoadedFormCollection.GetCountFromDB(whereClause);
			return GetFromDB();
		}
		...
		public ClassGenExceptionCollection GetFromDB() 
		{
			...
			try
			{
				sql = "SELECT " + (this.GetCollectionConfig.TopRecords > -1 ? "TOP " + this.GetCollectionConfig.TopRecords.ToString() + " " : "") +
					" [ULF].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserLoadedForm [ULF] " + 
				...
				this.OnMasterPopulate("UserLoadedForm", "Retrieving Full List Of UserLoadedForms", string.Empty);
				dt = DAL.SQLExecDataTable(cmd);
				...
				foreach (DataRow row in dt.Rows)
				{
					...
					this.OnDetailPopulate("UserLoadedForm", 
						"Populating UserLoadedForm: " + (++count).ToString("###,###,###,##0") + " of " + dt.Rows.Count.ToString("###,###,###,##0"), 
						string.Empty, 
						dt.Rows.Count, 
						count);
					...
					if (this.Contains(item.LoadedID)) { this.Remove(item.LoadedID); }
		...
		public ClassGenExceptionCollection AddUpdateAll(SqlConnection oConn, SqlTransaction oTrans)
		{
			...
			try
			{
				...
				{
					this.OnDetailDelete("UserLoadedForm",
						"Deleting UserLoadedForm: " + (this.Count - i + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						this.Count - i + 1);
					UserLoadedForm item = this[i];
					if (item.RecordStatus == RecordStatus.Deleted)
					{
						...
						else
						{
							...
							{
								err.RecordIndex = i + 1;
								err.RecordKey = item.LoadedID.ToString();
							}
				...
				// Update Method
				int count = 0;
				foreach (UserLoadedForm item in this)
				{
					this.OnDetailUpdate("UserLoadedForm",
						"Updating UserLoadedForm: " + (count + 1).ToString("###,###,###,##0") +
						" of " + this.Count.ToString("###,###,###,##0"),
						string.Empty,
						this.Count,
						count + 1);
		...
		public new UserLoadedFormCollection Clone()
		{
			UserLoadedFormCollection newColl = new UserLoadedFormCollection();
		...
		/// </summary>
		/// <returns>A new UserLoadedFormCollection.</returns>
		public new UserLoadedFormCollection CopyWithNewIDs()
		{
			return (UserLoadedFormCollection)base.CopyWithNewIDs();
		}
		...
		/// <param name="field">The field type to get.</param>
		/// <returns>A list of values from the collection (sorted by value).</returns>
		public List<string> GetDistinctFromCollection(LEAD.UserLoadedFormField field)
		{
			...
			switch (field)
			{
				case LEAD.UserLoadedFormField.LoadedID:
					foreach (UserLoadedForm item in this)
					{
						if (!String.IsNullOrEmpty(item.LoadedID.ToString()) && 
							!vals.ContainsKey(item.LoadedID.ToString().Trim())) { vals.Add(item.LoadedID.ToString().Trim(), item.LoadedID.ToString().Trim()); }
					}
					break;
				case LEAD.UserLoadedFormField.AgencyID:
					foreach (UserLoadedForm item in this)
					{
					...
					break;
				case LEAD.UserLoadedFormField.UserID:
					foreach (UserLoadedForm item in this)
					{
					...
					break;
				case LEAD.UserLoadedFormField.FormName:
					foreach (UserLoadedForm item in this)
					{
						if (!String.IsNullOrEmpty(item.FormName) && 
							!vals.ContainsKey(item.FormName.Trim())) { vals.Add(item.FormName.Trim(), item.FormName.Trim()); }
					}
					break;
				case LEAD.UserLoadedFormField.AddedByUser:
					foreach (UserLoadedForm item in this)
					{
					...
					break;
				case LEAD.UserLoadedFormField.UpdatedByUser:
					foreach (UserLoadedForm item in this)
					{
		...
		public ClassGenExceptionCollection BrokenRules
		{
			get 
			{
				...
				foreach (UserLoadedForm item in this.ActiveRecords)
				{
					...
					if (exCollection.Count > 0)
					{
						foreach (ClassGenException ex in exCollection)
						{
							...
							ex.RecordKey = item.LoadedID.ToString();
						}
		...
		/// </summary>
		/// <returns>A UserLoadedFormCollection of current records.</returns>
		public UserLoadedFormCollection GetCurrent()
		{
		...
		public bool Exists(long loadedID)
		{
			return (this.Exists(new Predicate<UserLoadedForm>(delegate (UserLoadedForm obj) 
				{ return obj.LoadedID == loadedID; })));
		}
		...
		/// </summary>
		/// <param name="loadedID">A key field used to find the correct record.</param>
		public void Remove(long loadedID)
		{
			for (int i = this.Count - 1; i >= 0; i--)
			{
				if (this[i].LoadedID == loadedID)
				{
					this.RemoveAt(i);
				}
			}
		...
		{
			// Return the data table
			return EmptyDataTableWithIL<UserLoadedForm>();
		}
		...
		public static int Delete(string whereClause, ref ClassGenExceptionCollection errors)
		{
			...
			try
			{
				sql = "DELETE FROM tUserLoadedForm " +
		...
		/// <summary>
		/// Attempt to serialize the UserLoadedFormCollection object to the server
		/// </summary>
		/// <param name="obj">The UserLoadedFormCollection object to serialize</param>
		/// <returns>A string containing the return from the method</returns>
		public static string SerializeObject(UserLoadedFormCollection obj)
		{
			string rtv = string.Empty;
		...
		/// <summary>
		/// Attempt to Deserialize the UserLoadedFormCollection object from the server
		/// </summary>
		/// <param name="obj">The UserLoadedFormCollection object to deserialize</param>
		/// <param name="errors">The errors collection</param>
		/// <returns>A UserLoadedFormCollection object containing the return from the method</returns>
		public static UserLoadedFormCollection DeserializeObject(string obj, ref ClassGenExceptionCollection errors)
		{
			UserLoadedFormCollection rtv = null;

			try
			{
				rtv = Newtonsoft.Json.JsonConvert.DeserializeObject<UserLoadedFormCollection>(obj);
			}
			catch (Exception ex)
			{
				errors.Add(new ClassGenException("Error: " + ex.Message, ClassGenExceptionIconType.Critical));
		...
		private void _backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			sql = 
				"IF object_id('tempdb..#UserLoadedForm') IS NOT NULL  DROP TABLE #UserLoadedForm; " + 
					"CREATE TABLE #UserLoadedForm (iLoadedID bigint, iItemIndex INT IDENTITY(1,1) PRIMARY KEY CLUSTERED);  " + 
					"INSERT INTO #UserLoadedForm (iLoadedID) SELECT iLoadedID FROM tUserLoadedForm" + 
					(!String.IsNullOrEmpty(this.GetCollectionConfig.WhereClause) ? " WHERE " + this.GetCollectionConfig.WhereClause : "") + ";  " + 
					"SELECT COUNT(*) AS iCount FROM #UserLoadedForm "; 
			cmd = new SqlCommand(sql);
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			if (e.UserState != null)
			{
				UserLoadedFormCollection_GetAsyncObject obj = (UserLoadedFormCollection_GetAsyncObject)e.UserState;
				this.OnGetThreadedProgress(obj.CurrentIndex, obj.TotalCount, obj.UserLoadedFormCollection);
			}
		}
			...
			int pageSize)
		{
			...
			while (currentIndex < totalCount)
			{
				...
				sql = "SELECT [ULF].*, GETDATE() AS dateTimeObjectPopulated " + 
					"FROM tUserLoadedForm [ULF] " + 
					"INNER JOIN #UserLoadedForm TEMP ON [ULF].[iLoadedID] = [TEMP].[iLoadedID] " +
				...
				// Populate the local UserLoadedForm collection
				coll = new UserLoadedFormCollection();
				foreach (DataRow row in dt.Rows)
				{
					item = new UserLoadedForm();
					item.Get(row);
					coll.Add(item);
				}
				...
				// Report the progress
				UserLoadedFormCollection_GetAsyncObject obj = new UserLoadedFormCollection_GetAsyncObject(currentIndex,
					totalCount, 
					coll);
		...
		/// </summary>
		public delegate void GetThreadedProgressEventHandler(object sender, UserLoadedForm_GetCollection_EventArgs e);
		/// <summary>
		...
		/// </summary>
		public void OnGetThreadedProgress(int currentIndex, int totalCount, UserLoadedFormCollection coll)
		{
			if (GetThreadedProgress != null)
			{
				// Add the items found in the collection to the current set
				foreach (UserLoadedForm a in coll)
				{
					this.Add(a);		// Add the UserLoadedForm
				}

				UserLoadedForm_GetCollection_EventArgs e = new UserLoadedForm_GetCollection_EventArgs(currentIndex, totalCount, coll);
		...
		public string GetAsXML(bool includeBaseProperties)
		{
			...
			sb.Insert(0, "<UserLoadedFormCollection>" + Environment.NewLine);
			sb.Append("</UserLoadedFormCollection>" + Environment.NewLine);
			...
			foreach (UserLoadedForm item in this)
			{
				switch (item.RecordStatus)
				{
					case RecordStatus.Current:
						...
						sbRead.Append("<UserLoadedForm>" + Environment.NewLine);
						sbRead.Append("\t<LoadedID>" + item.LoadedID.ToString() + "</LoadedID>" + Environment.NewLine);
						...
						sbRead.Append("\t<FormName>" + (item.FormName != null ? item.FormName : "NULL") + "</FormName>" + Environment.NewLine);
					...
					case RecordStatus.Deleted:
						sbDeleted.Append("<UserLoadedForm>" + Environment.NewLine);
						sbDeleted.Append("\t<LoadedID>" + item.LoadedID.ToString() + "</LoadedID>" + Environment.NewLine);
						...
						sbDeleted.Append("\t<FormName>" + (item.FormName != null ? item.FormName : "NULL") + "</FormName>" + Environment.NewLine);
					...
					case RecordStatus.New:
						sbNew.Append("<UserLoadedForm>" + Environment.NewLine);
						sbNew.Append("\t<LoadedID>" + item.LoadedID.ToString() + "</LoadedID>" + Environment.NewLine);
						...
						sbNew.Append("\t<FormName>" + (item.FormName != null ? item.FormName : "NULL") + "</FormName>" + Environment.NewLine);
		...
		/// <returns>The completed UserLoadedFormCollection object.</returns>
		public static UserLoadedFormCollection LoadFromXML(string xml)
		{
			UserLoadedFormCollection coll = new UserLoadedFormCollection();
			System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
			doc.LoadXml(xml);
			// <UserLoadedFormCollection>
			foreach (System.Xml.XmlNode nodeMain in doc.ChildNodes)
			{
				...
				foreach (System.Xml.XmlNode node in nodeMain.ChildNodes)
				{
					...
					UserLoadedForm item = UserLoadedForm.LoadFromXML(node.OuterXml);
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this._disposed)
			{
				...
				if (disposing)
				{
					...
					KeyedCollection = new Dictionary<long, UserLoadedForm>();

					FKKeyedCollection = new Dictionary<string, Dictionary<object, List<UserLoadedForm>>>();
	...
	#endregion UserLoadedForm Collection

	#region Event Handler for Async Object
	/// <summary>
	/// Custom class for UserLoadedForm event args such as population
	/// </summary>
	[Serializable]
	public class UserLoadedForm_GetCollection_EventArgs : EventArgs
	{
		private int _totalCount = 0;
		private int _currentIndex = 0;
		private UserLoadedFormCollection _coll = new UserLoadedFormCollection();

		/// <summary>
		/// Creates a new UserLoadedForm_GetCollection_EventArgs with the specified properties.
		/// </summary>
		...
		public UserLoadedForm_GetCollection_EventArgs(int currentIndex, int totalCount, UserLoadedFormCollection coll)
		{
		...
		/// <summary>
		/// Creates a new empty UserLoadedForm_GetCollection_EventArgs.
		/// </summary>
		public UserLoadedForm_GetCollection_EventArgs()
		{
		}
		...
		/// </summary>
		public UserLoadedFormCollection UserLoadedFormCollection
		{
			get { return _coll; }
		}
	}
	...
	/// <summary>
	/// An object to populate a UserLoadedFormCollection asynchronously.
	/// </summary>
	public class UserLoadedFormCollection_GetAsyncObject
	{
		private int _currentIndex = 0;
		private int _totalCount = 0;
		private UserLoadedFormCollection _coll = new UserLoadedFormCollection();
		...
		/// <summary>
		/// Creates a new UserLoadedForm_GetAsyncObject with the specified properties.
		/// </summary>
		/// <param name="currentIndex">The index of the current record to be populated.</param>
		/// <param name="totalCount">The total number of records to be collected.</param>
		/// <param name="coll">The collection holding the records.</param>
		public UserLoadedFormCollection_GetAsyncObject(int currentIndex, int totalCount, UserLoadedFormCollection coll)
		{
			_currentIndex = currentIndex;
			_totalCount = totalCount;
			_coll = coll;
